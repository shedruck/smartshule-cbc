						   ...
						   <br>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-user animated flipInY">
									...
									<?php 
									$sw = $this->portal_m->get_unenc_row('student',$this->user->id,'parent_switch');
									if(!empty($sw)){
									?>
											<?php  if ($this->ion_auth->is_in_group($this->user->id, 8)){?>
											<li role="separator" class="divider"></li>
											
											<li>
											<a href="<?php echo base_url('st/parents_switch/parent/'.$sw->parent.'/'.$sw->student); ?>"><i class="mdi mdi-account-convert"></i> Switch to Parent </a>
											</li>
											<?php } ?>
									<?php } ?>
									 <li role="separator" class="divider"></li>
                    ...
                    $(document).on('click', '.read', function(){
                        ...
                        if(conn==true){
                            ...
                            $.ajax({
                                ...
                                data: {'user_id':user_id,'zoom_id':zoom_id},
                                // dataType: 'json',
