    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            if (isNaN(q)) {
                ...
                for (p = 1; p < h; p++)
                    q = Math.round(b.length / h * p), b = b.substr(0, q) + m + b.substr(q);
...
AmCharts.AxisBase = AmCharts.Class({construct: function(a) {
        ...
        if (a) {
            ...
            var d = e.x, f = e.y;
            AmCharts.VML &&
                    (this.rotate ? d -= this.x : f -= this.y);
            var g = e.width, e = e.height, h = this.viW, k = this.viH, l = 0, m = a.getBBox().height / 2, n = this.inside;
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, n = 1, p = 0, r = Math.round((this.max - this.min) / this.step) + 1, u;
                ...
                w = !1;
                for (d = p; d < r; d += n)
                    A = AmCharts.roundTo(this.step * d + this.min, q), -1 != String(A).indexOf("e") && (w = !0, String(A).split("e"));
                ...
                for (d = p; d < r; d += n)
                    if (p =
                            q * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
                        if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
                            !0 === h && (0 === p && (p = this.minReal), 2 < u && (p = Math.pow(10, d)), w = -1 != String(p).indexOf("e") ? !0 : !1);
                            ...
                            if (!isNaN(I) && 0 < A && d < r - 1) {
                                ...
                                for (c = 1; c < q / I; c++)
                                    C = this.getCoordinate(p + I * c), C = new this.axisItemRenderer(this, C, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(C);
                                this.gridAlpha = s
                            }
                        }
                d = this.baseValue;
        ...
        for (k =
                this.start; k <= this.end; k++) {
            var u = 0;
            for (n = 0; n < h.length; n++)
                if (m = h[n], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, !isNaN(g)))) {
        ...
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)
                m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a ==
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if (c.valueAxis == this) {
                ...
                for (d = h; d <= g; d++) {
                    ...
                    var h = f.values, l;
                    for (l in h)
                        f.percents[l] = "percents" != l ? h[l] / e * 100 - 100 : h[l]
                }
            }
        }
    }, getMinMax: function() {
                ...
                if (c.hasOwnProperty(d)) {
                    ...
                    if (e.includeInMinMax && (!e.hidden || this.includeHidden)) {
                        ...
                        if (this.minMaxField)
                            ...
                            for (var g in e)
                                e.hasOwnProperty(g) &&
                                        "percents" != g && "total" != g && (f = e[g], f > a && (a = f))
                    }
                }
        }
        return a
        ...
        if (isNaN(a))
            return NaN;
        var b = this.rotate, c = this.reversed, d = this.axisWidth, e =
                this.stepWidth, f = this.min, g = this.minReal;
...
AmCharts.RecItem = AmCharts.Class({construct: function(a, b, c, d, e, f, g, h, k, l) {
        ...
        if ("H" == Fa) {
            if (0 <= b && b <= V + 1 && (0 < s && 0 < v && b + k <= V + 1 && (Y = AmCharts.line(r, [b + k, b + k], [0, s], t, v, A), u.push(Y)), 0 < w && (W = AmCharts.line(r, [b, b + da, b + da], [L, L + X, X], C, w, A, y), u.push(W))), D = 0, G = b, g && 90 == B && (G -= n), !1 === d ? (W = "start", D = "bottom" == ea ? S ? D + s : D - s : S ? D - s : D + s, G += 3, e && (G += e / 2, W = "middle"), 0 < B && (W = "middle")) : W = "middle", 1 == Z && 0 < J && !g && !l && $ <
                    ...
                    -(P / 2) * Math.sin(aa) - s - 6, G += P / 2 * Math.cos(aa)) : D -= s + n + 3 + q + 3), "bottom" == ea ? ha = (S ? L - s - 1 : L + q - 1) + oa : (ia = da, ha = (S ? X : X - s - q + 1) - oa), f && (G += f), X = G, 0 < B && (X += P / 2 * Math.cos(aa)), x && (ea = 0, S && (ea = P / 2 * Math.cos(aa)), X + ea > V + 2 || 0 > X))
                x.remove(), x = null
        } else {
...
AmCharts.AmChart = AmCharts.Class({construct: function(a) {
        ...
        if (AmCharts.VML || AmCharts.SVG)
            a = this.container, this.set = a.set(), this.gridSet = a.set(), this.graphsBehindSet =
    ...
    clearLabels: function() {
        ...
        if (c) {
            var d = this.legendDiv, e = d.offsetWidth, f = d.offsetHeight, d = d.style, g = this.chartDiv.style,
                    c = c.position;
            if ("right" == c || "left" == c) {
                a -= e;
                if (0 > a || isNaN(a))
        ...
        if ("amcharts.com" != b) {
            ...
            var f =
                    "http://www.amcharts.com/javascript-charts/", g = "charts", h = "";
...
AmCharts.AmGraph = AmCharts.Class({construct: function(a) {
        ...
        for (e = this.start; e <= this.end; e++) {
            ...
            !isNaN(h) && !isNaN(k) && (a.push(g), b.push(l), (h = this.createBullet(f,
                    g, l, e)) || (h = 0), k = this.labelText) && (f = this.createLabel(f, g, l, k), this.allBullets.push(f), this.positionLabel(g, l, f, this.labelPosition, h))
        }
        ...
        for (f = this.start; f <= this.end; f++) {
            ...
            if (isNaN(h))
                ...
                var k = this.y - (this.valueAxis.getCoordinate(h) -
                        this.height), l = 180 - 360 / (this.end - this.start + 1) * f;
        ...
        if (!da && ("line" == g || "smoothedLine" == g || "step" ==
                g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Ka || void 0 != Aa)) {
            var Ga = ea;
            Ga > f.max && (Ga = f.max);
            Ga < f.min && (Ga = f.min);
            f.logarithmic && (Ga = f.minReal);
            var wa = f.getCoordinate(Ga), ub = f.getCoordinate(f.max);
            n ? (ab = l, bb = Math.abs(ub - wa), db = l, eb = Math.abs(Za - wa), Ya = cb = 0, f.reversed ? (Wa = 0, Xa = wa) : (Wa = wa, Xa = 0)) : (bb = k, ab = Math.abs(ub - wa), eb = k, db = Math.abs(Za - wa), Xa = Wa = 0, f.reversed ? (Ya = m, cb = wa) : Ya = wa + 1)
        }
        var xa = Math.round;
        this.pmx = xa(Wa);
        this.pmy = xa(cb);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < Z) {
                for (H = Z - 1; - 1 < H; H--)
                    if (P = d[H], x = P.axes[f.id].graphs[b], Va = x.values.value, !isNaN(Va)) {
                        Z = H;
                        break
                    }
                if (this.lineColorField)
                    for (H = Z; - 1 < H; H--)
                        if (P = d[H], x = P.axes[f.id].graphs[b], x.lineColor) {
                ...
                if (this.fillColorsField)
                    for (H =
                            Z; - 1 < H; H--)
                        if (P = d[H], x = P.axes[f.id].graphs[b], x.fillColors) {
                            this.fillColorsSwitched = x.fillColors;
                            break
                        }
                if (this.dashLengthField)
                    for (H = Z; - 1 < H; H--)
                        if (P = d[H], x = P.axes[f.id].graphs[b], !isNaN(x.dashLength)) {
                            this.dashLengthSwitched = x.dashLength;
                            break
                        }
            }
            if (S < d.length - 1)
                for (H = S + 1; H < d.length; H++)
                    if (P = d[H], x = P.axes[f.id].graphs[b], Va = x.values.value, !isNaN(Va)) {
                        S = H;
                        break
                    }
        ...
        for (H = Z; H <= S; H++) {
            ...
            if (ta) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    R = ta.close, gb = ta.low, Ba = f.getCoordinate(gb), fb = ta.high, Ca = f.getCoordinate(fb);
                ka = ta.open;
                E = f.getCoordinate(R);
                isNaN(ka) || (O = f.getCoordinate(ka));
                if (!da)
                ...
                var ja = P.x[X.id], Ha = this.periodSpan - 1, ma = Math.floor(D / 2) + Math.floor(Ha * D / 2), za = ma, wb = 0;
                ...
                switch (g) {
                    case "line":
                        isNaN(R) ? u || (this.drawLineGraph(q,
                        ...
                        break;
                    case "smoothedLine":
                        isNaN(R) ? u || (this.drawSmoothedGraph(q, t, T, U), q = [], t = [], T = [], U = []) : (x.isNegative = R < ea ? !0 : !1, q.push(F), t.push(E),
                        ...
                        break;
                    case "step":
                        isNaN(R) ? u || (v = s = NaN, this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = []) : (x.isNegative = R < ea ? !0 : !1, void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U),
                    ...
                    case "column":
                        ...
                        if (!isNaN(R)) {
                            R < ea ? (x.isNegative = !0, Ka && (ya = Ka), void 0 != Aa && (la = Aa)) : x.isNegative = !1;
                            var xb = f.min, yb = f.max;
                            if (!(R < xb && ka < xb || R > yb && ka > yb))
                                if (n) {
                                    ...
                                    if (N < l && 0 < K && (na = new AmCharts.Cuboid(e, ba, K, z - a.d3x, J - a.d3y, ya, Qa, L, la, V, ha, r, n, Y, Ra), "bottom" != B && "inside" != B && "middle" != B))
                                    ...
                                    ba = AmCharts.fitToBounds(ba,
                                            -N + J * $, l - N);
                                    if (M < k + $ * z && 0 < K)
                                        if (na = new AmCharts.Cuboid(e, K, ba, z - a.d3x, J - a.d3y, ya, Qa, L, la, this.lineAlpha, ha, r, n, Y, Ra), 0 > R && "middle" != B && "inside" != B)
                                            B = "bottom";
                                        else if (B = aa, "regular" == I || "100%" == I)
                                            ga += this.dy
                                }
                            if (na && (sa = na.set, sa.translate(M, N), this.columnsSet.push(sa), (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !da)) {
                                ...
                                "3d" == I && (n ? (y = (C - c) * (this.end + 1 - H), ca += z * this.columnIndex, pa += z * this.columnIndex, x.y += z * this.columnIndex) : (y = (C - c) * (H + 1), ca +=
                                        3, ga += J * this.columnIndex + 7, qa += J * this.columnIndex, x.y += J * this.columnIndex));
                                if ("regular" == I || "100%" == I)
                                    "inside" != B && (B = "middle"), y = n ? 0 < ta.value ? (this.end + 1 - H) * C + c : (this.end + 1 - H) * C - c : 0 < ta.value ? C * H + c : C * H - c;
                    ...
                    case "candlestick":
                        if (!isNaN(ka) && !isNaN(R)) {
                            ...
                            void 0 != x.lineColor && (la = x.lineColor);
                            if (n) {
                                if (N = E - h / 2, M = Q, K = h, N + K > l && (K = l - N), 0 > N &&
                                        (K += N, N = 0), N < l && 0 < K) {
                                    var jb, kb;
                                    R > ka ? (jb = [F, Pa], kb = [Q, Oa]) : (jb = [Q, Pa], kb = [F, Oa]);
                                    !isNaN(Pa) && !isNaN(Oa) && E < l && 0 < E && ($a = AmCharts.line(e, jb, [E, E], la, V, L), ib = AmCharts.line(e, kb, [E, E], la, V, L));
                                    ba = F - Q;
                                    na = new AmCharts.Cuboid(e, ba, K, z, J, ya, La, L, la, V, ha, r, n, Y, Ra)
                                }
                            } else if (M = F - h / 2, N = O + L / 2, K = h, M + K > k && (K = k - M), 0 > M && (K += M, M = 0), ba = E - O, M < k && 0 < K) {
                                var na = new AmCharts.Cuboid(e, K, ba, z, J, ya, Qa, L, la, V, ha, r, n, Y, Ra), lb, mb;
                                R > ka ? (lb = [E, Ca], mb = [O, Ba]) : (lb = [O, Ca], mb = [E, Ba]);
                                !isNaN(Ca) && !isNaN(Ba) && F < k && 0 < F && ($a = AmCharts.line(e,
                                        [F, F], lb, la, V, L), ib = AmCharts.line(e, [F, F], mb, la, V, L))
                            }
                        ...
                        break;
                    case "ohlc":
                        if (!(isNaN(ka) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
                            R < ka && (x.isNegative = !0, void 0 != Aa && (ra = Aa));
                            var nb, ob, pb;
                            if (n) {
                                var qb = E - h / 2, qb = AmCharts.fitToBounds(qb, 0, l), zb = AmCharts.fitToBounds(E, 0, l),
                                        rb = E + h / 2, rb = AmCharts.fitToBounds(rb, 0, l);
                                ob = AmCharts.line(e, [Q, Q], [qb, zb], ra, V, L, Y);
                                0 < E && E < l && (nb = AmCharts.line(e, [Oa, Pa], [E, E], ra, V, L, Y));
                                pb = AmCharts.line(e, [F, F], [zb, rb], ra, V, L, Y)
                            } else {
                                var sb = F - h / 2, sb = AmCharts.fitToBounds(sb, 0, k), Ab = AmCharts.fitToBounds(F, 0, k), tb = F + h / 2, tb = AmCharts.fitToBounds(tb, 0, k);
                ...
                if (!da &&
                    ...
                    if (this.end - this.start <= Bb || 0 === Bb) {
                        ...
                        if (Cb) {
                            var fa = this.createLabel(x, 0, 0, Cb), ua = 0, va = 0, Db = fa.getBBox(), Ia = Db.width, Ea = Db.height;
                            switch (B) {
                                case "left":
                                    ua = -(Ia / 2 + Da / 2 + 3);
                                    break;
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    n && "column" == g ? (ca = Fa, 0 > R || 0 < R && f.reversed ? (ua = -6, fa.attr({"text-anchor": "end"})) : (ua = 6, fa.attr({"text-anchor": "start"}))) : (va = Da / 2 + Ea /
                                            2, fa.x = -(Ia / 2 + 2));
                                    break;
                                case "middle":
                                    "column" == g && (n ? (va = -(Ea / 2) + this.fontSize / 2, ua = -(F - Q) / 2 - z, 0 > ba && (ua += z), Math.abs(F - Q) < Ia && !this.showAllValueLabels && (fa.remove(), fa = null)) : (va = -(E - O) / 2, 0 > ba && (va -= J), Math.abs(E - O) < Ea && !this.showAllValueLabels && (fa.remove(), fa = null)));
                                    break;
                                case "inside":
                                    n ? (va = -(Ea / 2) + this.fontSize / 2, ua = 0 > ba ? Ia / 2 + 6 : -Ia / 2 - 6) : va = 0 > ba ? Ea : -Ea
                            }
                            if (fa) {
                                if (isNaN(ga) || isNaN(ca))
                                    fa.remove(), fa = null;
                        ...
                        if ("regular" == I || "100%" == I) {
                            ...
                            if (Fb) {
                                ...
                                var Gb = Ja.getBBox(), Hb = Gb.width, Ib = Gb.height, Sa, Ta, Jb = f.totals[H];
                                Jb && Jb.remove();
                                var Ua = 0;
                                "column" != g && (Ua = Da);
        ...
        if ("line" ==
            ...
            "smoothedLine" == g ? this.drawSmoothedGraph(q, t, T, U) : this.drawLineGraph(q, t, T, U), da || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            f.push(k);
            f.push(h);
            var l = e.lineAlpha, m = e.lineThickness, f = e.fillAlphas, n = e.lineColorR, p = e.negativeLineAlpha;
            isNaN(p) && (p = l);
            var r = e.lineColorSwitched;
            r && (n = r);
            var r = e.fillColorsR, u = e.fillColorsSwitched;
            u && (r = u);
            var q = e.dashLength;
            (u = e.dashLengthSwitched) && (q = u);
            var u = e.negativeLineColor, t = e.negativeFillColors, v = e.negativeFillAlphas, s = e.baseCoord;
            ...
            if (0 < f || 0 < v)
                if (m = a.join(";").split(";"), p = b.join(";").split(";"), "serial" == e.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), p = b.concat(d)) : e.rotate ? (p.push(p[p.length - 1]), m.push(s), p.push(p[0]), m.push(s), p.push(p[0]), m.push(m[0])) : (m.push(m[m.length - 1]), p.push(s), m.push(m[0]), p.push(s), m.push(a[0]), p.push(p[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(g, m, p, r, f, 1, "#000", 0, a), b.pattern(e.pattern), h.push(b)), t || void 0 !==
                        u)
                    isNaN(v) && (v = f), t || (t = u), g = AmCharts.polygon(g, m, p, t, v, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g), k.click(function(a) {
                        e.handleGraphClick(a)
                    });
            e.applyMask(k, h)
        }
        ...
        if (1 < a.length) {
            ...
            e.push(h);
            e.push(g);
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n =
                    this.lineColorR, p = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, q = this.negativeFillAlphas, t = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
            ...
            0 < m && (k = a.join(";").split(";"), n = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), k = a.concat(c), n =
                    b.concat(d)) : (this.rotate ? (l += " L" + t + "," + b[b.length - 1], l += " L" + t + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + t, l += " L" + a[0] + "," + t), l += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, k, n, NaN, 0, 0, p, m, e, l), c.path.pattern(this.pattern), g.push(c.path), u || void 0 !== r) && (q || (q = m), u || (u = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, u, q, e, l), a.path.pattern(this.pattern), h.push(a.path));
            this.applyMask(h, g)
        }
        ...
        b && (this.rotate ? (b.translate(-1E3, e), c.translate(-1E3, e)) : (b.translate(d, -1E3), c.translate(d, -1E3)), b.animate({opacity: 1, translate: d + "," + e}, f, a), c.animate({opacity: 1,
            translate: d + "," + e}, f, a))
    }, animate: function(a) {
    ...
    addListeners: function(a, b) {
        ...
        if (a) {
            var c = this.chart, d = {type: "rollOverGraphItem", item: a, index: a.index,
        ...
        a = {type: "clickGraph", graph: this, target: this, chart: this.chart, event: a};
        ...
        if (a) {
            var c = {type: "doubleClickGraphItem", item: a, index: a.index,
                graph: this, target: this, chart: this.chart, event: b};
...
AmCharts.ChartCursor = AmCharts.Class({construct: function(a) {
        ...
        var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness, g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, n = this.x, p = this.y, r = this.width, u = this.height, a = a.rotate, q = c.tickLength;
        g.pointerWidth = q;
        ...
        0 < this.cursorAlpha && (d.show(), e.show(), d.translate(b,
                0), e.translate(0, c));
        ...
        isNaN(a) ||
                (c > a && (e = a, g = c - a), c < a && (e = c, g = a - c), c == a && (e = a, g = 0));
        ...
        this.rotate ? this.selectionPosY =
                f = e.mouseY : this.selectionPosX = f = e.mouseX;
        this.start = a;
        this.end = b;
        this.startTime = c;
        this.endTime = d;
        ...
        if (this.enabled) {
            ...
            this.fireMoved();
            if (p) {
                var r = p.x[f.id], u = c.rotate, q = f.inside, t = this.stepWidth, v = this.categoryBalloon,
                        s = this.firstTime, w = this.lastTime, A = this.cursorPosition, C = f.position, y = this.zooming, z = this.panning, J = c.graphs, I = f.axisThickness;
                if (c.mouseIsOver || y || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        var g = this.panClickPos, c = this.panClickEndTime, y = this.panClickStartTime, B = this.panClickEnd, k = this.panClickStart, d = (u ? g - e : g - d) / t;
                        if (!f.parseDates || f.equalSpacing)
                            d = Math.round(d);
                        0 !== d && (g = {type: "zoomed", target: this}, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c), y + d < s && (d = s - y), g.start = y + d, g.end =
                                c + d, this.fire(g.type, g)) : B + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = B + d, this.fire(g.type, g)))
                    } else {
                        ...
                        0 < this.cursorAlpha && (s = this.line, u ? (w = 0, t = r + h) : (w = r, t = 0), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ?
                                s.translate(w, t) : (s.translate(this.previousX, this.previousY), s.animate({translate: w + "," + t}, A, "easeOutSine")) : s.translate(w, t), this.previousX = w, this.previousY = t, s.show());
                        this.linePos = u ? r + h : r;
                        y && (u ? this.updateSelectionSize(NaN, r) : this.updateSelectionSize(r, NaN));
                        t = !0;
                        y && (t = !1);
                        this.categoryBalloonEnabled && t ? (u ? (q && ("right" == C ? v.setBounds(k, l + h, k + m + g, l + r + h) : v.setBounds(k, l + h, k + m + g, l + r)), "right" == C ? q ? v.setPosition(k + m + g, l + r + h) : v.setPosition(k + m + g + I, l + r + h) : q ? v.setPosition(k, l + r) : v.setPosition(k - I, l + r)) :
                                "top" == C ? q ? v.setPosition(k + r + g, l + h) : v.setPosition(k + r + g, l + h - I + 1) : q ? v.setPosition(k + r, l + n) : v.setPosition(k + r, l + n + I - 1), (s = this.categoryBalloonFunction) ? v.showBalloon(s(p.category)) : f.parseDates ? (f = AmCharts.formatDate(p.category, this.categoryBalloonDateFormat), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, p.category)), v.showBalloon(f)) : v.showBalloon(AmCharts.fixNewLines(p.category))) : v.hide();
                        J && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            h = Infinity;
                            for (w = 0; w < J.length; w++)
                                f =
                                        J[w], f.showBalloon && !f.hidden && f.balloonText && (v = p.axes[f.valueAxis.id].graphs[f.id], s = v.y, isNaN(s) || (u ? Math.abs(d - s) < h && (h = Math.abs(d - s), B = f) : Math.abs(e - s) < h && (h = Math.abs(e - s), B = f)));
                            this.mostCloseGraph && (B = this.mostCloseGraph)
                        }
                        if (a != this.previousIndex || B != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
                                this.valueBalloons = h = [];
                                for (w = 0; w < J.length; w++)
                                    if (f = J[w], (!this.oneBalloonOnly || f ==
                                            B) && f.showBalloon && !f.hidden && f.balloonText) {
                                        v = p.axes[f.valueAxis.id].graphs[f.id];
                                        s = v.y;
                                        if (this.showNextAvailable && isNaN(s) && a + 1 < this.data.length)
                                            for (r = a + 1; r < this.data.length; r++)
                                                if (q = this.data[r])
                                                    if (v = q.axes[f.valueAxis.id].graphs[f.id], s = v.y, !isNaN(s))
                                                        break;
                                        if (!isNaN(s)) {
                                            q = v.x;
                                            t = !0;
                                            if (u) {
                                                if (r = s, 0 > q || q > n)
                                                    t = !1
                                            } else if (r = q, q = s, 0 > r || r > m + g + 1)
                                                t = !1;
                                            t && (1 != this.graphBulletSize && AmCharts.isModern && (t = v.bulletGraphics) && (t.getBBox(), t.translate(v.bx, v.by, this.graphBulletSize), this.resizedBullets.push(v)),
                                                    t = f.valueBalloon, C = c.getBalloonColor(f, v), t.setBounds(k, l, k + m, l + n), t.pointerOrientation = "H", t.changeColor(C), void 0 !== f.balloonAlpha && (t.fillAlpha = f.balloonAlpha), void 0 !== f.balloonTextColor && (t.color = f.balloonTextColor), t.setPosition(r + k, q + l), r = c.formatString(f.balloonText, v, !0), (q = f.balloonFunction) && (r = q(v, f).toString()), "" !== r && (u ? t.showBalloon(r) : (t.text = r, t.show = !0)), !u && t.set && t.set.hide(), h.push({yy: s, balloon: t}))
                                        }
                                    }
                                u || this.arrangeBalloons()
                            }
                        b ? (g = {type: "changed"}, g.index = a, g.chart = this.chart,
                                g.zooming = y, g.mostCloseGraph = B, g.position = u ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function(a) {
        ...
        if (l = a.graph) {
            ...
            for (r = 0; r < c.length; r++) {
                var u = c[r].axes[p.id].graphs[l.id].values, q;
                for (q in u)
                    if (u.hasOwnProperty(q) && "percents" != q && "total" != q) {
                        var t = u[q];
                        t < f && (f = t);
                        t > g && (g = t)
                    }
...
AmCharts.AmBalloon = AmCharts.Class({construct: function(a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                C.position = "absolute";
                m.innerHTML = '<div style="max-width:' + this.maxWidth + "px; font-size:" + A + "px; color:" +
                ...
                0 < s || 0 === t ? (0 < q && (a = AmCharts.rect(e, y, w, n, 0, u + 1, I, q, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, y, w, n, this.fillAlpha, u, p, this.borderAlpha, this.cornerRadius), this.showBullet && (Z = AmCharts.circle(e, B, r, this.fillAlpha), f.push(Z))) : (r = [], s = [], "H" != v ? (g = a - A, g > y - t && (g = y - t), g < t && (g = t), r = [0, g - t, a - A, g + t, y, y, 0, 0],
                        s = J ? [0, 0, b - z, 0, 0, w, w, 0] : [w, w, b - z, w, w, 0, 0, w]) : (r = b - z, r > w - t && (r = w - t), r < t && (r = t), s = [0, r - t, b - z, r + t, w, w, 0, 0], r = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, y, y, 0] : [y, y, A + y > a ? y : a - A, y, y, 0, 0, y]), 0 < q && (a = AmCharts.polygon(e, r, s, n, 0, u, I, q), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, r, s, n, this.fillAlpha, u, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: A - e + "," + z}, b, "easeOutSine"), m && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = A - e;
                this.prevY = z;
                this.prevTX = l;
                this.prevTY = h
    ...
    createValueAxes: function() {
        ...
        if (e) {
            ...
            for (p = 0; p < e.length; p++) {
                ...
                k && (u.forceShow = q[k]);
                n[q[d]] = u;
                f && (b = h.categoryFunction ? h.categoryFunction(b, q, h) : b instanceof Date ? "fff" == h.minPeriod ? AmCharts.useUTC ? new Date(b.getUTCFullYear(), b.getUTCMonth(), b.getUTCDate(), b.getUTCHours(), b.getUTCMinutes(), b.getUTCSeconds(), b.getUTCMilliseconds()) : new Date(b.getFullYear(), b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(),
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function(a) {
        ...
        isNaN(a) ? a.hidden = !1 : this.chartData[a].hidden =
                !1;
        ...
        var f = this.formatString(this.balloonText, a, !0), g = AmCharts.adjustLuminosity(a.color, -0.15);
        ...
        if (void 0 !== b) {
            ...
            for (e = 0; e < a.length; e++)
                c ? g = AmCharts.adjustLuminosity(c,
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function(a) {
        ...
        for (l = 0; l < a.length; l++)
            b = this.getAxisBounds(a[l], g, k, h, b), g = b.l, k = b.r, h = b.t, b = b.b;
    ...
    }, getScrollbarPosition: function(a,
            b, c) {
...
AmCharts.TrendLine = AmCharts.Class({construct: function(a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, u = a.initialXValue, q = a.finalXValue, t = a.initialValue, v = a.finalValue,
...
AmCharts.bullet = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    switch (b) {
        ...
        case "yError":
            ...
            break;
        case "xError":
            n = a.set(), n.push(AmCharts.line(a, [-c / 2, c / 2], [0, 0], d, e, f)), n.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k],
                    d, e, f)), n.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d, e, f))
    }
    n && n.pattern(m);
    return n
};
...
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var p = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], u = 1; u < p.length; u++)
            n.push(AmCharts.line(a, [p[u - 1], p[u]], [r[u - 1], r[u]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    g = p(g);
    h = p(h);
    var r = p(g / f * h), u = AmCharts.VML, q = 359.5 + f / 100;
    359.94 < q && (q = 359.94);
    e >= q && (e = q);
    var t = 1 / 180 * Math.PI, q = b + Math.sin(d * t) * h, v = c - Math.cos(d * t) * r, s = b + Math.sin(d * t) * f, w = c - Math.cos(d * t) * g, A = b + Math.sin((d + e) * t) * f, C = c - Math.cos((d + e) * t) * g, y = b + Math.sin((d + e) * t) * h, t = c - Math.cos((d + e) * t) * r, z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, J = 0;
    180 < Math.abs(e) && (J = 1);
    d = a.set();
    var I;
    ...
    0 < k && (u ? (B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k), I || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + s + "," + (w + k) + "," + A + "," + (C + k)), B += " L" + y + "," + (t + k), 0 < h && (I || (B += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) +
...
AmCharts.AmDraw = AmCharts.Class({construct: function(a, b, c, d) {
        ...
        if (AmCharts.hasSVG) {
            ...
            AmCharts.isIE && AmCharts.VMLRenderer && (AmCharts.VML = !0, AmCharts.vmlStyleSheet || (document.namespaces.add("amvml", "urn:schemas-microsoft-com:vml"), e = document.createStyleSheet(),
                    e.addRule(".amvml", "behavior:url(#default#VML); display:inline-block; antialias:true"), AmCharts.vmlStyleSheet = e), this.container = a, this.R = new AmCharts.VMLRenderer(this, d), this.R.disableSelection(a))
        ...
        0 < a && 0 < b && (this.container.style.width = a + "px", this.container.style.height =
                b + "px")
...
AmCharts.AmLegend = AmCharts.Class({construct: function(a) {
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, r = 0, u = this.container, q = u.set();
        this.set = q;
        u = u.set();
        q.push(u);
        ...
        if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
            "center" == this.align ? b = f + (h - v.width) / 2 : "right" == this.align && (b = f + h - v.width);
        u.translate(b, l + 1);
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m = a.type, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
                    this.switchType = void 0, g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k,
                            a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l / 3;
                else {
                    var r;
            ...
            (f = this.switchType) && "none" != f && (r = "x" == f ? this.createX() : this.createV(), r.dItem = a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(), this.switchable || r.hide(), this.addListeners(r, a), a.legendSwitch = r, k.push(r));
            f = this.color;
    ...
    createV: function() {
        ...
        var a = this.markerSize - 4, b = {stroke: this.switchColor, "stroke-width": 3}, c = this.container, d = AmCharts.line(c, [3, a], [3, a]).attr(b), a = AmCharts.line(c, [3, a], [a, 3]).attr(b);
