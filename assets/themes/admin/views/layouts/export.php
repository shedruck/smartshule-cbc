...
<html lang="en">
    <head>        
        ...
        <?php echo theme_css('font-awesome/css/font-awesome.min.css'); ?>
		       ...
		       <?php echo theme_css('datatables.css'); ?>
        <!--[if lt IE 10]>
...
<?php echo theme_js('plugins/jquery/jquery.min.js'); ?>
        ...
        <?php echo theme_js('select2/select2.min.js'); ?>
		   ...
		   <!-- start: JAVASCRIPTS REQUIRED FOR DATATABLES -->
     <?php echo theme_js('datatables/js/jquery.dataTables.min.js'); ?>
	 <?php echo theme_js('datatables/extensions/buttons/js/dataTables.buttons.min.js'); ?>
	 <?php echo theme_js('datatables/extensions/buttons/js/jszip.min.js'); ?>
	 <?php echo theme_js('datatables/extensions/buttons/js/vfs_fonts.js'); ?>
	 <?php echo theme_js('datatables/extensions/buttons/js/buttons.print.min.js'); ?>
	 <?php echo theme_js('datatables/extensions/buttons/js/buttons.html5.min.js'); ?>
	 <?php echo theme_js('datatables/js/pdfmake.min.js'); ?>
     <?php echo theme_js('datatables/extensions/buttons/js/extension-btns-custom.js'); ?>
    <?php echo theme_js("datatables/pdfmake/build/vfs_fonts.js"); ?>
    <?php echo theme_js("datatables/table-export.min.js"); ?>
	...
	<script>
	    ...
	    jQuery(document).ready(function() {
			...
			$('.buttons-excel').addClass('btn btn-sm btn-info');
			$('.buttons-pdf').addClass('btn btn-sm btn-danger');
			$('.buttons-print').addClass('btn btn-sm btn-warning');
			$('#basic-btn_info').hide();
		});
	</script>
