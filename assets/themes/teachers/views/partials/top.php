                     ...
                     <div class="d-flex align-items-center">
                         ...
                         <div class="header-element country-dropdown dropdown-center">
                             ...
                             <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/us_flag.jpg" class="rounded-circle header-link-icon" alt="img">
                             </a>
                             ...
                             <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                 <ul class="mb-0">
                                     <li class="dropdown-item mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/india_flag.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                     ...
                                     <li class="dropdown-item mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/malaysia.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                             <div class="flex-grow-1">
                                     ...
                                     <li class="dropdown-item mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/italy_flag.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                             <div class="flex-grow-1">
                                     ...
                                     <li class="dropdown-item mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/argentina.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                             <div class="flex-grow-1">
                                     ...
                                     <li class="dropdown-item active mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/us_flag.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                             <div class="flex-grow-1">
                                     ...
                                     <li class="dropdown-item mb-1">
                                         <div class="d-flex align-items-center">
                                             <div class="pe-2">
                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/flags-img/turkey.jpg" class="rounded-circle country-img" alt="img">
                                             </div>
                                             <div class="flex-grow-1">
                                 ...
                                 <ul class="mb-0 overflow-auto" id="header-cart-items-scroll">
                                     <li class="dropdown-item">
                                         <div class="d-flex align-items-start cart-dropdown-item">
                                             <img src="<?php echo base_url('assets/themes/teachers') ?>/images/products/1.jpg" alt="img" class="avatar avatar-md br-5 me-3">
                                             <div class="flex-grow-1">
                                     ...
                                     <li class="dropdown-item">
                                         <div class="d-flex align-items-start cart-dropdown-item">
                                             <img src="<?php echo base_url('assets/themes/teachers') ?>/images/products/2.jpg" alt="img" class="avatar avatar-md br-5 me-3">
                                             <div class="flex-grow-1">
                                                 <div class="d-flex align-items-start justify-content-between mb-0">
                                     ...
                                     <li class="dropdown-item">
                                         <div class="d-flex align-items-start cart-dropdown-item">
                                             <img src="<?php echo base_url('assets/themes/teachers') ?>/images/products/3.jpg" alt="img" class="avatar avatar-md br-5 me-3">
                                             <div class="flex-grow-1">
                                                 <div class="d-flex align-items-start justify-content-between mb-0">
                                                     <div class="mb-0 fs-14 text-dark fw-semibold">
                                     ...
                                     <li class="dropdown-item">
                                         <div class="d-flex align-items-start cart-dropdown-item">
                                             <img src="<?php echo base_url('assets/themes/teachers') ?>/images/products/5.jpg" alt="img" class="avatar avatar-md br-5 me-3">
                                             <div class="flex-grow-1">
                                                 <div class="d-flex align-items-start justify-content-between mb-0">
                                                     <div class="mb-0 fs-14 text-dark fw-semibold">
                                                     ...
                                                     <div>
                                                         ...
                                                         <a href="profile.html" class="d-flex align-items-center mt-1">
                                                             <span class="avatar avatar-sm brround">
                                                                 <img src="<?php echo base_url('assets/themes/teachers') ?>/images/users/1.jpg" class="brround" alt="img">
                                                             </span>
