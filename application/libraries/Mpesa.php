...
class Mpesa
{
    ...
    {
         $consumer_key = "tKbVfYIAMXs4llpRDY3F7ClFSRGRm73l";
         $consumer_secret = "V79WMyU1qG2qh31m";
    ...
    public static function generateSandBoxToken(){
        //$consumer_key= env("K0bas8ABhvNhyklXr4XYV4n7IpwdkHqZ");
        $consumer_key= "K0bas8ABhvNhyklXr4XYV4n7IpwdkHqZ";
        //$consumer_secret= env("5Fxa2TWfNVGtRlWH");
        $consumer_secret= "5Fxa2TWfNVGtRlWH";
        if(!isset($consumer_key)||!isset($consumer_secret)){
            die("please declare the consumer key and consumer secret as defined in the documentation");
        }
