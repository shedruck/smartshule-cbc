...
class Asset {
    ...
    public function css($asset_name, $module_name = NULL, $attributes = array(), $location_type = '') {
        ...
        $pathb = $this->{$location_type}($asset_name, $module_name);
        $pathc = str_replace(BASE_URI . BASE_URI, BASE_URI, $pathb);
        return '<link href="' . $pathc . '" type="text/css"' . $attribute_str . ' />';
           }
    ...
    public function image($asset_name, $module_name = '', $attributes = array(), $location_type = '') {
        ...
        $location = str_replace(BASE_URI . BASE_URI, BASE_URI, $location);
    ...
    public function js($asset_name, $module_name = NULL, $location_type = '') {
        ...
        $pathb = $this->{$location_type}($asset_name, $module_name);
        $pathc = str_replace(BASE_URI . BASE_URI, BASE_URI, $pathb);
        return '<script type="text/javascript" src="' . $pathc . '"></script>';
    }
     ...
     * Plugin Path
     *
     * Helps generate Plugin asset paths.
     *
     * @access		public
     * @param		string    the name of the file or asset
     * @param		string    optional, module name
     * @return		string    web root path to JavaScript asset
     */
    public function plugin_path($asset_name, $module_name = NULL) {
        return $this->_asset_path($asset_name, $module_name, config_item('asset_plugin_dir'));
    }
