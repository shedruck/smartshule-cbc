...
//                $args = &func_get_args();
  ...
  //              $limit = &func_get_args();
         ...
         * @author Ben
         */
        public function select_key($field, $table = '')
        {
                if ($field == 'id')
                {
                        if ($table)
                ...
                else
                {
                        if ($table)
                        {
                                $this->db->select(array("AES_DECRYPT($table.$field," . "SHA2('" . MD5 . "',512)" . ") as $field"));
                        }
                        else
                        {
                                $this->db->select(array("AES_DECRYPT($field," . "SHA2('" . MD5 . "',512)" . ") as $field"));
                        }
                }
        }

        /** Select all columns with decrypt
         *
         ...
         * @author Ben
         */
        public function select_all_key($table_name, $alias = '')
        {
                ...
                foreach ($fields as $field)
                {
                        ...
                        $this->select_key($field, $table_name);
                }
        }
         ...
         * @return type
         */
        public function secure_key($data)
        {
                $data2 = "'" . $this->db->escape_str($data) . "'";
                $res = $this->db->query("select HEX(AES_ENCRYPT($data2,SHA2('" . MD5 . "',512))) as data")->row();

                return $res->data;
        }

        /**
         *  Insert a new record into the database, for Predefined Table
         * calling the before and after create callbacks.
         *
         * @param array $data
         ...
         */
        public function insert_key($data, $skip_validation = FALSE)
        {
                $valid = TRUE;
                if ($skip_validation === FALSE)
                {
         ...
         * @author Ben
         */
        public function insert_key_data($table, $data)
        {
                //encrypt data
                if ($data && count($data))
                {
         ...
         * @author Ben
         */
        public function update_key_data($id, $table, $data)
        {
         ...
         * @author Ben
         */
        public function update_key_all($table, $data)
        {
         ...
         * @return boolean
         */
        public function update_key_where($where, $table, $data)
        {
                //encrypt data
                if ($data && count($data))
                {
         ...
         * @return boolean
         */
        public function update_where($where, $table, $data)
        {
                //encrypt data
                if ($data && count($data))
                {
         ...
         * @return boolean
         */
        public function batch_update_key_data($table, $ar_data)
        {
                //encrypt data
        ...
        {
                return " AES_ENCRYPT($field,SHA2('" . MD5 . "',512)) ";
        }

        public function dx($field)
        {
                return " AES_DECRYPT($field,SHA2('" . MD5 . "',512)) ";
        }

        public function dxa($field)
        {
                return " AES_DECRYPT($field,SHA2('" . MD5 . "',512)) as $field ";
        }
