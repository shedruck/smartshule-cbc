...
$config['theme_asset_dir'] = APPPATH.'themess/';
...
$config['theme_asset_url'] = config_item('base_url').'application/themesxs/';
...
$config['asset_plugin_dir'] = 'plugins';