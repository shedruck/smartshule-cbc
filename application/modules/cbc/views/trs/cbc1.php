                    ...
                    <tbody>
                        ...
                        foreach ($classes as $class)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('trs/cbc/assess/' . $class->id) ?>" class="btn btn-custom">Formative /Termly <i class="mdi mdi-arrow-right"></i></a>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo base_url('trs/cbc/social_report/' . $class->id . '?s=1') ?>">Social Behavior</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
