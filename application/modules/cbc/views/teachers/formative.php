                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <button class="btn btn-primary off-canvas mt-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" onclick="show_subjects(<?php echo $cl ?>)"><i class="fas fa-file-alt"></i> Begin Formative</button>
                            </div>
