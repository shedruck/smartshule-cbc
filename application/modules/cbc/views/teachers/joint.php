    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h6 class="float-start">GENERATE JOINT REPORT</h6>
                <div class="btn-group btn-group-sm float-end" role="group">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#inputModal" data-bs-whatever="@mdo">Add Thread</button>
                    ...
                    <table id="datatable-basic" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                        ...
                                        <td>
                                            <div class="btn-group my-2">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item text-success" href='<?php echo site_url('cbc/trs/results/' . $p->id); ?>'><i class='fa fa-share'></i> Results</a></li>
                                                    <li><a class="dropdown-item text-primary" data-bs-toggle="modal" data-bs-target="#editModal_<?php echo $p->id ?>"><i class='fa fa-edit'></i> Edit</a></li>
                                                    <li><a class="dropdown-item text-danger" onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('cbc/trs/delete_thread/' . $p->id); ?>''><i class=' fa fa-trash'></i> Trash</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                ?>
                                <tr>
                                    <td colspan="5" class="text-center">No Joint Exam Threads Found</td>
                                </tr>
                            <?php } ?>
                        </tbody>
