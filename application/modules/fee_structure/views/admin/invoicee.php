                ...
                <div class="statement">
                    <div class="invoice slip-content">
                        ...
                        <table cellpadding = "0" cellspacing = "0" width = "100%" class = "stt" style = "margin-bottom: 6px;">
                            ...
                            $actual = ($has_wv ? ($arr + $wvd) - $extra : $arr - $extra) - $rem;
                            if ($has_wv)
                            {
                                $tot = $tot - $wvd;
                            }
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3">
                                <img src="<?php echo base_url('mpesaa-removebg-preview.png')?>" style="width: 90%; height: 50%; margin-top: 0%;">
                            </div>
                            <div class="col-md-6 col-sm-6">
                             <h5>
                                <?php $settings= $this->ion_auth->settings()?>
                                <strong> Payment:</strong> M-PESA<br>
                                 <strong>Paybill Number:</strong> <?php echo $settings->mobile_pay;?><br>
