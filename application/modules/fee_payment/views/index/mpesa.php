		...
		<?php 
			...
			echo   form_open_multipart('fee_payment/index/stkpush', $attributes); 
		?>
            
            <div class="row-fluid">
			
			    <span class="label-s"> Student UPI code *</span>
                <div class="input-prepend">
                    <?php echo form_input('reg_no' ,$result->reg_no , 'id="reg_no"   class="form-control" required="required" onblur="upi_checker()" placeholder="Student UPI Number *"' );?>
