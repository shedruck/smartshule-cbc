            ...
            <h2> General  E-videos  </h2>
             <div class="right"> 
              ...
              <?php echo anchor( 'admin/general_evideos' , '<i class="glyphicon glyphicon-list">
                </i> '.lang('web_list_all', array(':name' => 'General E-videos')), 'class="btn btn-primary"');?> 
...
<!--
<div class='form-group'>
	<div class="col-md-3" for='level'>Level </div><div class="col-md-6">
	<?php 
...
<div class='form-group'>
	...
	<?php echo form_input('subject' ,$result->subject , 'id="topic_"  class="form-control" ' );?>
...
<div class='widget'>
  <div class='head dark'>
	...
	<h2>Description </h2></div>
	 <div class="block-fluid editor">
	<textarea id="description"   style="height: 100px;" class="  "  name="description"  /><?php echo set_value('description', (isset($result->description)) ? htmlspecialchars_decode($result->description) : ''); ?></textarea>
...
<div class='form-group'><div class="col-md-3"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/general_evideos','Cancel','class="btn  btn-default"');?>
</div></div>
...
<div class="clearfix"></div>
    ...
    jQuery(function () {
        ...
        jQuery("#level").change(function () {
            ...
            jQuery.getJSON("<?php echo base_url('admin/general_evideos/list_subjects'); ?>", {id: jQuery(this).val()}, function (data) {
