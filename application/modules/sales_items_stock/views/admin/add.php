...
<div class='form-group'>
	<div class="col-md-3" for='item_id'>Item <span class='required'>*</span></div>
<div class="col-md-6">
                 <?php 
			
						 echo form_dropdown('item_id', $items,  (isset($result->item_id)) ? $result->item_id : ''     ,   ' class="select populate" ');
