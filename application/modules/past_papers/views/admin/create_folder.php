...
<div class='form-group'>
	...
	<?php echo form_input('title' ,'', 'id="title_"  class="form-control" required="required" placeholder="KCSE 2000, MOCK 1998"' );?>
...
<div class='form-group'><div class="col-md-3"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/past_papers','Cancel','class="btn  btn-default"');?>
</div></div>
