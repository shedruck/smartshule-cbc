        ...
        <div class="head"> 
            ...
            <h2>  Record Sales  </h2>
             ...
             <?php echo anchor( 'admin/record_sales/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Record Sales')), 'class="btn btn-primary"');?> 
...
<div class='form-group'>
	<div class="col-md-3" for='sales_date'>Sales Date <span class='required'>*</span></div><div class="col-md-6">
