...
<div class="toolbar">
    <div class="col-md-12"><br/>
        ...
        Bus
        <?php echo form_dropdown('bus', array('' => 'All Buses') + $buses, $this->input->post('bus'), 'class ="tsel" '); ?>
        Class
...
<div class="block invoice">
    <div class="row">
        <div class="col-md-12">
            ...
            <hr/>
            <?php if (!empty($res)): ?>
                <?php echo form_open(base_url('admin/transport/remove_students'))?>
                    <table class="table" width="100%">
                        ...
                        <th>Term</th>   
                        <th>Year</th>  
                        <th ><input type="checkbox" class="checkall" id="cck" /><label for="cck"> All</label></th> 
                        </thead>
                        <tbody>
                            <?php
                            $i = 0;
                            foreach ($res as $r):
                                    ...
                                    <tr>
                                        ...
                                        <td>  <input type="checkbox" name="item[<?php echo $r->id ?>]" value="<?php echo $r->id?>" class="switchx check-lef"> </td>
                                    </tr>
                            <?php   endforeach ?>
                        </tbody>
                    </table>
