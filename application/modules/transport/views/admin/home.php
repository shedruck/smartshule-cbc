    ...
    <div class="block-fluid">
       ...
       <table class="table">
            <tr>
                ...
                <td width="20%">
                    <?php
                    echo form_dropdown('bus', ['' => 'Select Bus'], '', ' id="bss" class="fsel fetcher"');
                    echo form_error('bus');
                    ?>
                </td>
                <td width="20%">
            ...
            return function (t, n, o, i) {
                ...
                }, t.select2(i).on("change", function (i) 
                {
                    n.prop("disabled", !0), e.getJSON(o.replace(":parentId:", e(this).val()), function (e) {
                        var o = '<option value="">-- Select Stage --</option>';
                        for (var i in e)
    ...
    $(document).ready(function ()
    {
        var Select2Cascade = function (t, e) {
            return function (t, n, o, i) {
                ...
                {
                    n.prop("disabled", !0), e.getJSON(o.replace(":parentId:", e(this).val()), function (e) {
                        var o = '<option value="">-- Select Bus --</option>';
                        for (var i in e)
                            o += '<option value="' + i + '">' + e[i] + "</option>";
                        n.select2("destroy").html(o).prop("disabled", !1).select2(c), a.forEach(function (o) {
                            o(t, n, e)
        ...
        var s2Options = {width: 'resolve'};
        var cascadLoading = new Select2Cascade($('#z1'), $('#bss'), '<?php echo base_url(); ?>admin/transport/bus_route/:parentId:', s2Options);
        cascadLoading.then(function (parent, child, items)
        {
        });
    });
