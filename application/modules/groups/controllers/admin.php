...
class Admin extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['groups'] = $this->groups_m->paginate_all($config['per_page'], $page);
        ...
        //load view
        $this->template->title(' Groups ')->build('admin/list', $data);
    }
    ...
    function create($page = NULL)
    {
        ...
        {         //Validation OK!
            ...
            $ok = $this->groups_m->create($form_data);
        ...
        else
        {
            ...
            $this->template->title('Add Groups ')->build('admin/create', $data);
        }
    }
    ...
    function edit($id = FALSE, $page = 0)
    {
        ...
        if (!$this->groups_m->exists($id))
        {
            $this->session->set_flashdata('message', array('type' => 'warning', 'text' => lang('web_object_not_exist')));
            redirect('admin/groups');
        }
        //search the item to show in edit form
        $get = $this->groups_m->find($id);
        ...
        if ($this->form_validation->run())  //validation has been passed
        {
            ...
            $done = $this->groups_m->update_attributes($id, $form_data);
        ...
        $data['result'] = $get;
        //load the view and the layout
        $this->template->title('Edit Groups ')->build('admin/create', $data);
    }
    ...
    function delete($id = NULL, $page = 1)
    {
        ...
        //delete the item
        if ($this->groups_m->delete($id) == TRUE)
        {
			  //$details = implode(' , ', $this->input->post());
				$user = $this->ion_auth->get_user();
					$log = array(
    ...
    private function set_paginate_options()
    {
        ...
        $config['total_rows'] = $this->groups_m->count();
