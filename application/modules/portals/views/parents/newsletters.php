													...
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="<?php echo base_url()?>uploads/files/<?php echo $p->file?>" class="booking-doc-img">
																 <iframe src="<?php echo base_url()?>uploads/files/<?php echo $p->file?>" width="100%" height="250px"></iframe>
															</a>
															<div class="profile-det-info">
																<h4><a target="_blank" href="<?php echo base_url()?>uploads/files/<?php echo $p->file?>" class="text-primary"><?php echo $p->title;?></a></h4>
																<div>
