<?php
   ...
   <?php $set = $this->ion_auth->settings();?>
   
   <?php if($set->exam_lock==1){?>
     <div class="card-header d-flex align-items-center justify-content-between">
      <h4 class="card-title mb-0 d-inline-block" style="color:red">Sorry Exams results has been locked for recording purpose. You will be alerted once it has been opened</h4>
     </div>
   <?php }else{?>
<div class="card card-group-row mb-lg-8pt">
   <div class="card-header d-flex align-items-center justify-content-between">
      <h4 class="card-title mb-0 d-inline-block">Filter to View Exam Results</h4>
   </div>
   <div class="col-md-12">
      <p>&nbsp;</p>
      ...
      <div class="form-group row">
         <div class="col-md-4">
            <?php echo form_dropdown('student',  $students, $this->input->post('student'), 'class="tsel  form-control select"'); ?>
         </div>
         <div class="col-md-4">
            <?php echo form_dropdown('exam', array('' => 'SELECT EXAM') + $exams, $this->input->post('exam'), 'class="tsel  form-control"'); ?>
         </div>
         <div class="col-md-2">
      ...
      <button onClick="window.print();
         return false" class="btn btn-primary btn-sm pull-right" type="button" style="margin-left:5%;"> Print Report</button>
      <?php
         }
         echo form_close();
         ?>
         ...
         <div class="slip ">
            ...
            <div>
               ...
               <div class="foo col-sm-12">
                  <b><span ><b style="text-decoration:underline">Next Term Commences on:</b> &nbsp;&nbsp; _______________________ &nbsp;&nbsp; </span></b>
            ...
            <tr>
               ...
               <?php
                  foreach ($tts as $tid => $ttl)
                  {
                          ...
                          ?>
               <td><?php echo $ttl; ?></td>
               <td colspan="2" class="bglite"><span class="editable remarks" id="<?php echo $nm; ?>" ><?php echo $srmk; ?></span></td>
            </tr>
            <?php
               }
               }
