<div class="portlet mt-2">
    <div class="portlet-heading portlet-default border-bottom">
		...
		<div class="pull-right">
		 ...
		 <?php echo anchor( 'qa/st/', '<i class="fa fa-list"></i> List All', 'class="btn btn-info btn-sm "');?>
...
<hr>
		...
		<div class="row" id="qas" style="display:none !important">
			<div class="col-sm-12">
   ...
   <script>
	...
	$("#start").click(function () {
				   ...
				   swal({
							...
							.then((willDelete) => {
							  if (willDelete) {
								  window.location="<?php echo base_url('qa/st/qa_start/'.$post->id.'/'.$this->session->userdata['session_id'])?>";
