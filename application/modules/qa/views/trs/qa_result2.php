    ...
    <div class="col-sm-12">
        <div class="portlet-heading portlet-default border-bottom">
            <h3 class="portlet-title text-dark">
                <b> <?php $st = $this->portal_m->find($student);
                       echo $p->title; ?> Result for : <?php echo $st->first_name; ?> <?php echo $st->middle_name; ?> <?php echo $st->last_name; ?> </b>
            </h3>
                        ...
                        <tbody>
                            ...
                            <tr class="profile-th">
                                ...
                                <td class="bg-red" colspan="3">
                                    <p class="font18"><b class=""><?php $pt = (float) ($sum_awarded_points * 100) / $sum_qa_points;
                                                                   echo round($pt, 2) ?>% </b> </p>
                            ...
                            <tr class="profile-th">
                                ...
                                <td class="bg-green required">
                                    <p class="font18"><?php  //echo $qa_correct;
                                                       ?></p>
                                </td>
                                <td class="bg-black">
                                ...
                                <td class="bg-green required" colspan="">
                                    <p class="font18"><?php  //echo $count_qstns;
                                                       ?></p>
                                </td>
                            </tr>
