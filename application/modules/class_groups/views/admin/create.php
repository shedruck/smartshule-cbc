<div class="col-md-8">
    ...
    <div class="block-fluid">
        ...
        <div class='form-group'>
            <div class="col-md-3" for='name'>Class / Level Name </div><div class="col-md-6">
		...
		<div class='form-group'>
			<div class="col-md-3" for='education_system'>Education System  </div>
		<div class="col-md-6">
			<?php $items = array('' =>'Select System', 
					"1"=>"8.4.4 / I.G.S.C.E",
					"2"=>"CBC",
					);		
			 echo form_dropdown('education_system', $items,  (isset($result->education_system)) ? $result->education_system : ''     ,   ' id="education_system" class="select" data-placeholder="Select Options..." ');
			 echo form_error('education_system'); ?>
		</div></div>
