<div class="portlet mt-2">
	...
	<div class="block-fluid">
		...
		<div class='form-group'>
			<div class="col-md-3  control-label" for='strand'>Strand </div>
			<div class="col-md-6">
		...
		<div class='form-group'>
			<div class="col-md-3  control-label" for='substrand'>Sub-strand </div>
			<div class="col-md-6">
...
<script>
	jQuery(function() {
		...
		jQuery("#class").change(function() {
			...
			jQuery.getJSON("<?php echo base_url('record_of_work_covered/trs/list_subjects'); ?>", {
				id: jQuery(this).val()
			}, function(data) {
