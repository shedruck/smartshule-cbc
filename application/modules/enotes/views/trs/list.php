                    ...
                    <td>
                     <div class="btn-group my-2">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item text-success" href='<?php echo site_url('enotes/trs/view/' . $p->id . '/' . $this->session->userdata['session_id']); ?>'><i class='fa fa-share'></i> View</a></li>
                          <li><a class="dropdown-item text-primary" href='<?php echo site_url('enotes/trs/edit/' . $p->id . '/' . $this->session->userdata['session_id']); ?>'><i class='fa fa-edit'></i> Edit</a></li>
                          <li><a class="dropdown-item text-danger" onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('enotes/trs/delete/' . $p->id . '/' . $this->session->userdata['session_id']); ?>''><i class=' fa fa-trash'></i> Trash</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
