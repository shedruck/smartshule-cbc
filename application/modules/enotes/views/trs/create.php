      ...
      <div class="card-body p-2">
        ...
        <div class="col-dm-9 col-xl-9 col-lg-9 col-sm-12 mt-3 mb-3">
          ...
          <div class="row m-2">
            ...
            <div class="col-sm-9">
              <textarea id="soft" style="height: 120px;" class="editor form-control" name="soft" /><?php echo isset($result->soft) ? htmlspecialchars_decode($result->soft) : ''; ?></textarea>
          ...
          <div class="row m-2">
            ...
            <div class="col-sm-9">
              <textarea id="remarks" style="height: 120px;" class="editor form-control" name="remarks" /><?php echo isset($result->remarks) ? htmlspecialchars_decode($result->remarks) : ''; ?></textarea>
