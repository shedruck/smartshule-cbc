<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	{	   $config = $this->set_paginate_options(); //Initialize the pagination class
                ...
                $data['enotes'] = $this->enotes_m->paginate_all($config['per_page'], $page);
	...
	//page number  variable
	 $data['page'] = $page;
            ...
            //load view
            $this->template->title(' Enotes ' )->build('admin/list', $data);
	}
        ...
        $form_data = array(
			...
			redirect('admin/enotes/');
                ...
                {   
                 ...
                 $data['result'] = $get; 
		 //load the view and the layout
		 $this->template->title('Add Enotes ' )->build('admin/create', $data);
		}		
	}
        ...
        if ( $done) 
			...
			else
			{
             ...
             else
             {
               ...
               $data['result'] = $get;
             //load the view and the layout
             $this->template->title('Edit Enotes ' )->build('admin/create', $data);
	}
...
return $config; 
	...
	{
		$config = array();
		$config['base_url'] = site_url() . 'admin/enotes/index/';
