			...
			<div class="col-md-12">
					...
					<div class='control-group'>
						<label class='control-label' for='cc'>Cc </label>
							<div class="controls">
							<?php echo form_input('cc' ,$emails_m->cc , 'id="cc"  class="col-md-4" id="focusedinput" ' );?>
					...
					<div class='control-group'>
						<label class=' control-label' for='subject'>Subject </label>
							<div class="controls">
						<?php echo form_input('subject' ,$emails_m->subject , 'id="subject_"  class="col-md-4" id="focusedinput" ' );?>
