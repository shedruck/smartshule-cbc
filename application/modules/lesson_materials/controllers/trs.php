<?php defined('BASEPATH') OR exit('No direct script access allowed');
   ...
   class Trs extends Trs_Controller
	...
	{	   $config = $this->set_paginate_options(); //Initialize the pagination class
                ...
                $data['lesson_materials'] = $this->lesson_materials_m->get_all_lm($config['per_page'], $page);
            ...
            //load view
            $this->template->title(' Lesson Materials ' )->build('trs/list', $data);
	}

    function new_lesson_materials($page = NULL)
        {
        ...
        $form_data = array(
			...
			redirect('lesson_materials/trs');
                ...
                {   
                 ...
                 $data['result'] = $get; 
		 //load the view and the layout
		 $this->template->title('Add Lesson Materials ' )->build('trs/create', $data);
		}		
	}
	...
	{ 
        ...
        //search the item to show in edit form
         $data['post'] =  $this->lesson_materials_m->find($id); 
		 $this->template->title('View Lesson Materials ' )->build('trs/view', $data);
	}
        ...
        if ( $done) 
			...
			else
			{
             ...
             else
             {
               ...
               $data['result'] = $get;
             //load the view and the layout
             $this->template->title('Edit Lesson Materials ' )->build('trs/create', $data);
	}
...
return $config; 
	...
	{
		$config = array();
		$config['base_url'] = site_url() . 'lesson_materials/trs/index/';
