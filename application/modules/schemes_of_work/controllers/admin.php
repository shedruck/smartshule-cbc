<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	{	   $config = $this->set_paginate_options(); //Initialize the pagination class
                ...
                $data['schemes_of_work'] = $this->schemes_of_work_m->paginate_all($config['per_page'], $page);
	...
	//page number  variable
	 $data['page'] = $page;
            ...
            //load view
            $this->template->title(' Schemes Of Work ' )->build('admin/list', $data);
	}
        ...
        $form_data = array(
		 ...
		 $this->template->title('Add Schemes Of Work ' )->build('admin/create', $data);
		}		
	}
        ...
        if ( $done) 
			...
			else
			{
             ...
             else
             {
               ...
               $data['result'] = $get;
             //load the view and the layout
             $this->template->title('Edit Schemes Of Work ' )->build('admin/create', $data);
	}
...
return $config; 
	...
	{
		$config = array();
		$config['base_url'] = site_url() . 'admin/schemes_of_work/index/';
