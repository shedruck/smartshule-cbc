<div class="portlet mt-2">
    ...
    <div class="block-fluid">
        ...
        <div class='row'>
            <div class="col-md-4  " for='day'>Year </div>
            <div class="col-md-8">
                <?php
        ...
        <div class='row'>
            <div class="col-md-4  " for='day'>Term </div>
            <div class="col-md-8">
                <?php
                echo $result->term
                ?>
        ...
        <div class='row'>
            <div class="col-md-4 " for='class'>Class/Level </div>
            <div class="col-md-8">
                <?php
        ...
        <div class='row'>
            <div class="col-md-4 " for='week'>Week </div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4 " for='subject'>Subject/Learning Area </div>
            <div class="col-md-8">
                <?php
        ...
        <div class='row'>
            <div class="col-md-4 " for='strand'>Strand </div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4   " for='substrand'>Sub-strand </div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4  " for='topic'>Lesson</div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4" for='topic'>Specific Learning Outcomes</div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4" for='topic'>Key Inquiry Question</div>
            <div class="col-md-8">
        ...
        <hr>
        <div class='row'>
            <div class="col-md-4" for='topic'>Learning Experiences</div>
            <div class="col-md-8">
        ...
        <hr>
        <div class='row'>
            <div class="col-md-4" for='topic'>Learning Resources</div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4" for='topic'>Assessment</div>
            <div class="col-md-8">
        ...
        <div class='row'>
            <div class="col-md-4" for='topic'>Reflection</div>
            <div class="col-md-8">
