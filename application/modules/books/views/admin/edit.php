...
<div class='form-group'>
	<div class="col-md-2" for='author'>Author <span class='required'>*</span></div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='publisher'>Publisher <span class='required'>*</span></div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='year_published'>Year Published </div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='isbn_number'>ISBN Number </div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='category'>Category <span class='required'>*</span></div><div class="col-md-10">
	  <?php 		
     echo form_dropdown('category',$category,  (isset($result->category)) ? $result->category : ''     ,   ' class="chzn-select" data-placeholder="Select Options..." ');
     echo form_error('category'); ?>
</div>
</div>

<div class='form-group'>
	<div class="col-md-2" for='edition'>Edition </div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='pages'>Pages </div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='copyright'>Copyright </div><div class="col-md-10">
...
<div class='form-group'>
	<div class="col-md-2" for='shelf'>Shelf </div><div class="col-md-10">
