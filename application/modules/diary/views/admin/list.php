...
<?php if ($diary): ?>
    ...
    <div class="block-fluid">
        ...
        <table class="fpTable" cellpadding="0" cellspacing="0" width="100%">
            <thead>
            <th>#</th><th>Student</th><th>Activity</th><th>Date </th><th>Teacher</th><th>Status</th> <th>Teacher Comment</th><th>Parent Comment</th>	<th ><?php echo lang('web_options'); ?></th>
        ...
        <hr>
        <center>
            <button class="btn btn-primary" onclick="return confirm('Are you sure?')" type="submit" value="1" name="diary">Approve Selected</button>
        </center>
        <?php echo form_close()?>
