<div class="portlet mt-2">
    <div class="portlet-heading portlet-default border-bottom">
        ...
        <div class="portlet-widgets">
            <?php echo anchor('trs/diary', '<i class="mdi mdi-reply"></i> Back', 'class="btn btn-primary"'); ?>
        </div>
    ...
    <div id="bg-default" class="panel-collapse collapse in">
        <div class="portlet-body">
            ...
            <div class='form-group'>
                ...
                <div class="col-md-6">
                    <a href="<?php echo base_url('trs/diary'); ?>" class="btn btn-default">  <i class="mdi mdi-close"></i> <span>Cancel</span></a>
