...
class  Trs extends Trs_Controller
{
  ...
  public function index()
  {
    ...
    $data['diary'] = $this->diary_m->paginate_all($config['per_page'], $page, $this->user->id);
  ...
  public function extra()
  {
    ...
    $this->pagination->initialize($config);
    $page = ($this->uri->segment(4)) ? $this->uri->segment(4) : 1;
    $data['diary'] = $this->diary_m->paginate_extra($config['per_page'], $page, $this->user->id);
  ...
  function delete($id = NULL, $cat = 2)
  {
    ...
    if (!$id) {
      $this->session->set_flashdata('message', array('type' => 'warning', 'text' => lang('web_object_not_exist')));
      $cat == 2 ? redirect('diary/trs/extra') : redirect('trs/diary');
    }
