...
class Admin extends Admin_Controller
{
    ...
    public function index($teacher = FALSE)
    {
        $config = $this->set_paginate_options(); //Initialize the pagination class
        $this->pagination->initialize($config);
        $page = ($this->uri->segment(4)) ? $this->uri->segment(4) : 1;
        $data['lesson_plan'] = $this->lesson_plan_m->paginate_all($config['per_page'], $page, $teacher);
        $data['teachers'] = $this->lesson_plan_m->get_trs();
        ...
        //load view
        $this->template->title(' Lesson Plan ')->build('admin/list', $data);
    }
    ...
    function create($page = NULL)
    {
        ...
        if ($this->form_validation->run()) {         //Validation OK!
            ...
            $this->template->title('Add Lesson Plan ')->build('admin/create', $data);
        }
    }
    ...
    function edit($id = FALSE, $page = 0)
    {
        ...
        $data['result'] = $get;
        //load the view and the layout
        $this->template->title('Edit Lesson Plan ')->build('admin/create', $data);
    }
    ...
    {
        $config = array();
        $config['base_url'] = site_url() . 'admin/lesson_plan/index/';
