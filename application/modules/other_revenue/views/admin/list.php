<div class="head"> 
            ...
            <h2>  Other Revenue  </h2>
             ...
             <a href="<?php echo base_url('admin/revenue_categories')?>" class="btn btn-success"><i class="glyphicon glyphicon-folder-open"></i> Revenue Categories</a>
               <?php echo anchor( 'admin/revenue_categories/', '<i class="glyphicon glyphicon-folder-open"></i> '.lang('web_add_t', array(':name' => 'Revenue Categories')), 'class="btn btn-primary"');?>
	 ...
	 <tr>
			 ...
			 <td width='30'>
						 <div class='btn-group'>
						<a class="btn btn-danger" onClick="return confirm('Are you sure you want to void this revenue This cannot be undone.')" href='<?php echo site_url('admin/other_revenue/void/'.$p->id.'/'.$page);?>'><i class='glyphicon glyphicon-trash'></i> Void</a>
							...
							<ul class='dropdown-menu pull-right'>
								...
								<li><a class="btn btn-danger"  onClick="return confirm(\"Are you sure you want to void this payment?")" href='<?php echo site_url('admin/other_revenue/delete/'.$p->id.'/'.$page);?>'><i class='glyphicon glyphicon-trash'></i> Trash</a></li>
							</ul>
						</div>
					</td>
				</tr>
