<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  Newsletters  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/newsletters/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Newsletters')), 'class="btn btn-primary"');?> 
...
<div class='form-group'>
	<div class="col-md-3" for='file'> Upload Newsletter  <span class='required'>*</span></div>
 <div class="col-md-6">
	<input id='file' type='file' name='file' required="required" />

	<?php if ($updType == 'edit'): ?>
	<a href='<?php echo base_url()?>uploads/files/<?php echo $result->file?>' />Download actual file (file)</a>
	<?php endif ?>
...
<div class='form-group'><div class="col-md-3"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/newsletters','Cancel','class="btn  btn-default"');?>
</div></div>
