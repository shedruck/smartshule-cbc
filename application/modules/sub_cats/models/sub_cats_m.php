<?php
class Sub_cats_m extends MY_Model{
    ...
    function count()
    {
        ...
        return $this->db->count_all_results('sub_cats');
    }
...
function populate($table,$option_val,$option_text)
{
    ...
    function delete($id)
    {
        return $this->db->delete('sub_cats', array('id' => $id));
     }
    ...
    function paginate_all($limit, $page)
    {
            ...
            $query = $this->db->get('sub_cats', $limit, $offset);
