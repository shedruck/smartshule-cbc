<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  Positions  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/positions/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Positions')), 'class="btn btn-primary"');?> 
...
<div class='form-group'><div class="col-md-3"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/positions','Cancel','class="btn  btn-default"');?>
</div></div>
