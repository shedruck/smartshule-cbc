        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="row">
                    ...
                    <div class='col-md-6 p-5' style="border-right:2px solid #ccc; border-left:2px solid #c">
                        <div class='row'>
                            <div class="col-md-3" for='strong'><b>Class/Level</b> </div>
                            <div class="col-md-6">
                                <?php
                        ...
                        <div class='row'>
                            <div class="col-md-3" for='student'><b>Student</b> </div>
                            <div class="col-md-6">
                        ...
                        <div class='row'>
                            <div class="col-md-3 " for='day'><b> Year </b> </div>
                            <div class="col-md-6">
                                <?php
                        ...
                        <div class='row'>
                            <div class="col-md-3 " for='day'><b>Term </b> </div>
                            <div class="col-md-6">
                                <?php
                        ...
                        <div class='row'>
                            <div class="col-md-3" for='subject'><b>Subject/Learning Area </b> </div>
                            <div class="col-md-6">
                                <?php
                        ...
                        <hr>
                        <div class='row'>
                            <div class="col-md-3" for='strand'><b>Strand </b> </div>
                            <div class="col-md-6">
                        ...
                        <div class='row'>
                            <div class="col-md-3 control-label" for='topic'><b>Remarks</b> </div>
                            <div class="col-md-6">
