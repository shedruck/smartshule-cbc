<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	{	   $config = $this->set_paginate_options(); //Initialize the pagination class
                ...
                $data['students_projects'] = $this->students_projects_m->paginate_all($config['per_page'], $page);
	...
	//page number  variable
	 $data['page'] = $page;
            ...
            //load view
            $this->template->title(' Students Projects ' )->build('admin/list', $data);
	}
        ...
        $form_data = array(
			...
			redirect('admin/students_projects/');
                ...
                {   
                 ...
                 $data['result'] = $get; 
		 //load the view and the layout
		 $this->template->title('Add Students Projects ' )->build('admin/create', $data);
		}		
	}
        ...
        if ( $done) 
			...
			else
			{
             ...
             else
             {
               ...
               $data['result'] = $get;
             //load the view and the layout
             $this->template->title('Edit Students Projects ' )->build('admin/create', $data);
	}
...
return $config; 
	...
	{
		$config = array();
		$config['base_url'] = site_url() . 'admin/students_projects/index/';
