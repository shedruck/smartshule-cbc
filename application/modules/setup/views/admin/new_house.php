<div class="block-fluid">
    <div class="head dark"> 
        ...
        <h2>  House  </h2>
        <div class="right"> 
            <?php echo anchor('admin/setup/houses', '<i class="glyphicon glyphicon-list">
                </i> ' . lang('web_list_all', array(':name' => 'Houses')), 'class="btn btn-primary"'); ?> 
        </div>
    </div> 
    <div class="block-fluid col-md-8">
        ...
        <div class='form-group'>
            <div class="col-md-3" for='slogan'>Slogan </div><div class="col-md-9">
                <?php echo form_input('slogan', $result->slogan, 'id="slogan_"  class="form-control" '); ?>
        ...
        <div class='form-group'>
            ...
            <div class="col-md-9">
                ...
                echo form_dropdown('leader', array('' => 'Select Leader') + (array) $items, (isset($result->leader)) ? $result->leader : '', ' class="chzn-select" data-placeholder="Select Options..." ');
        ...
        <div class='form-group'><div class="col-md-3"></div><div class="col-md-9">
                ...
                <?php echo anchor('admin/setup/houses', 'Cancel', 'class="btn  btn-default"'); ?>
            </div></div>
