<div class="head"> 
	 ...
	 <thead>
		...
		<?php 
            ...
            foreach ($sales_items_category as $p ): 
                 $i++;
                     ?>
	 <tr>
			 ...
			 <td width='20%'>
						 <div class='btn-group'>
							...
							<ul class='dropdown-menu pull-right'>
								 <li><a href='<?php echo site_url('admin/sales_items_category/edit/'.$p->id.'/'.$page);?>'><i class='glyphicon glyphicon-eye-open'></i> View</a></li>
								<li><a  href='<?php echo site_url('admin/sales_items_category/edit/'.$p->id.'/'.$page);?>'><i class='glyphicon glyphicon-edit'></i> Edit</a></li>
							  
								<li><a  onClick="return confirm('<?php echo lang('web_confirm_delete')?>')" href='<?php echo site_url('admin/sales_items_category/delete/'.$p->id.'/'.$page);?>'><i class='glyphicon glyphicon-trash'></i> Trash</a></li>
							</ul>
						</div>
					</td>
				</tr>
