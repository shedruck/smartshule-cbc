<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  Mc  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/mc/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Mc')), 'class="btn btn-primary"');?> 
...
<div class='form-group'>
	...
	<?php echo form_input('level' ,$result->level , 'id="level_"  class="form-control" ' );?>
