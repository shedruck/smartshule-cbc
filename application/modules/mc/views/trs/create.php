...
<div class="portlet mt-2">
    <div class="portlet-heading portlet-default border-bottom">
        <h3 class="portlet-title text-dark">
		 ...
		 <?php echo anchor( 'mc/trs/', '<i class="fa fa-list"></i> List All', 'class="btn btn-primary btn-sm pull-right"');?>
...
<div class='form-group'>
	<div class="col-md-3 control-label" for='title'>Title <span class='required'>*</span></div><div class="col-md-6">
...
<div class='form-group'><div class="col-md-3 control-label"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/mc','Cancel','class="btn  btn-default"');?>
</div></div>
