			...
			<div>
				...
				<ul class="list-group list-group-flush border">
					...
					<div id="data-container">
						...
						?>
							<a href="<?php echo base_url('mc/trs/post_mc/' . $post->id . '/' . $cl->id . '/' . $this->session->userdata['session_id']) ?>" onclick="return confirm('Are you sure you want to post this assignment for the learners?')">
