<section class="box ">
    <div class="panel panel-default"> 
        <header class="panel_header">
            <h2 class="title pull-left"><?php echo ($updType == 'edit') ? 'Edit ' : 'Add '; ?> Member </h2>
            <div class="actions panel_actions pull-right">
                <?php echo anchor('admin/users/create', '<span><i class="fa fa-plus white"></i> Add Staff Member</span>', 'class="btn btn-success" '); ?> 
                <?php echo anchor('admin/non_teaching', '<span><i class="fa fa-list white"></i> All Staff Non_teaching' . '</span>', 'class="btn btn-info"'); ?> 
            </div>
        </header>
