<?php
class Non_teaching_m extends MY_Model{
    ...
    {
        $this->insert_key_data('non_teaching', $data);
    ...
    function find($id)
    {
		...
		return $this->db->where(array('id' => $id))->get('non_teaching')->row();
     }
...
function staff_sickness($id)
    ...
    function exists($id)
    {
          return $this->db->where( array('id' => $id))->count_all_results('non_teaching') >0;
    }
  function exists_mg($mem,$gp)
    ...
    function count()
    {
        ...
        return $this->db->count_all_results('non_teaching');
    }

    function update_attributes1($id, $data)
    {
         return  $this->db->where('id', $id) ->update('non_teaching', $data);
    }
	
 function update_attributes($id, $data)
    {
		  return  $this->update_key_data($id,'non_teaching', $data);
...
function populate($table,$option_val,$option_text)
{
    ...
    function delete($id)
    {
        return $this->db->delete('non_teaching', array('id' => $id));
     }
    ...
    function paginate_all($limit, $page)
    {
            ...
            $query = $this->db
						...
						->order_by('non_teaching.id', 'DESC')
						->get('non_teaching', $limit, $offset);
