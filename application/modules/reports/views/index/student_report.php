...
<div class="widget">
    <div class="col-md-12 slip" style="font-size:16px !important;">

       
        <div class="statement" style="font-size:16px !important;">
		
		
            <div class="block invoice slip-content" style="font-size:16px !important;">
			
			<div class="center" style="text-align:center">This report is being viewed by <b><?php echo $cc->name;?></b> of phone number <b><?php echo $cc->phone;?></b> & email <b><?php echo $cc->email;?></b> </div>
			<hr>
                        ...
                        <div class=" ">
                            ...
                            <div class="center">
                                ...
                                <h4> <abbr><?php echo ucwords($this->school->school); ?> </abbr>
									...
									<span class="border col-md-12">________________________</span>
        ...
        <?php endif ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($national_exams as $p):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
															<a href='#' onClick="return confirm('Serial number required to view this document')" /> <i class="glyphicon glyphicon-download"></i> Download File</a>
															</td>				
                                                            <td><?php echo date('d M Y', $p->created_on); ?></td>				
                                                            <td><?php echo ucwords($u->first_name . ' ' . $u->last_name); ?></td>
                                                        </tr>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($other_certs as $p):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
															<a onClick="return confirm('Serial number required to view this document')" href='#' /> <i class="glyphicon glyphicon-download"></i> Download File</a>
															</td>				
                                                            <td><?php echo date('d M Y', $p->created_on); ?></td>				
                                                            <td><?php echo ucwords($u->first_name . ' ' . $u->last_name); ?></td>
                                                        </tr>
                ...
                }else
                {
					...
					<h3>Sorry no records were found at the moment</h3>
<?php } ?>
