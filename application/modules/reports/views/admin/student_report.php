    ...
    <div class="col-md-12 slip">
            ...
            <div class="block invoice slip-content">
                ...
                if (isset($student) && !empty($student))
                {
						...
						<div class="row">
                            <div class="col-md-12">
							<hr>
						    <h2 class="center"><?php echo ucwords($student->first_name . ' ' .$student->middle_name . ' ' . $student->last_name); ?> Full Report 
                                     ...
                                     <div class="info-s profile" style="text-align:center">
											<div class='btn btn-default btn-sm'>
											   <?php
                                                ...
                                                <h5><?php echo $paro->f_title; ?> 
												<?php echo $paro->first_name . ' ' .$paro->f_middle_name . ' ' . $paro->last_name ?></h5>
                                                <table border="0" width="100%">
		...
		<div class="user-info card-body">
                            ...
                            <div class="col-md-12">
							 ...
							 <span style="width:400px">
                                    <h3 style="border:1px solid #ccc; text-align:center; background-color:#F5F5F5; "> Favourites & Hobbies</h3>
                                </span>
