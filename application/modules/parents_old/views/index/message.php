                ...
                <div class="borders">
                            ...
                            <form autocomplete="off" class="form-inline margin-none">
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default btn-xs pull-right"><i class="glyphicon glyphglyphicon glyphicon-search"></i></button>
                                    </span>
                                </div>
                            </form>
                        </div>
                        <div id="tabs-control" class="bg-gray strong border-top border-bottom text-center">
                            <div class="col-md-6 padding-none"><a href="/chat/messages.php#" id="tab-chats" class="tab border-right active-tab">
                                    <div id="loadingDiv-chats"></div>
                                    <span class="glyphicon glyphglyphicon glyphicon-envelope"></span> Conversations</a>
                            </div>
                            <div class="col-md-6 padding-none"><a href="/chat/messages.php#" id="tab-contacts" class="tab">
                                    <div id="loadingDiv-contacts"></div>
                                    <span class="glyphicon glyphglyphicon glyphicon-user"></span> Contacts (<?php echo count($staff); ?>)</a>
                            </div>
                                    ...
                                    <li class="prepare-message border-bottom" id="<?php echo $sid; ?>">
                                        <div class="media innerBox">
                                            <div class="media-object pull-left hidden-phone">
                                                <a href="#"><?php echo theme_image('avatar/' . $avt . '/50.png', array('alt' => "User")); ?></a>
                                            </div>
                    ...
                    <div class="col-md-8 messageWrapper">
                        ...
                        <div id="text-messages-request" tabindex="5001" style="overflow: hidden; outline: none; cursor: -webkit-grab;">
                            <p class="innerBox">Start a Conversation by selecting a contact on the left</p>
                        </div>
                    </div>
...
<input type="hidden" id="upload-tm" value="1423043677">
