...
class Admin extends Admin_Controller
{
        ...
        function __construct()
        {
                ...
                $this->load->model('medical_records_m');
        }
        ...
        public function index()
        {
                ...
                $data['medical_records'] = $this->medical_records_m->paginate_all($config['per_page'], $page);
                ...
                //load view
                $this->template->title(' Medical Records ')->build('admin/list', $data);
        }
        ...
        function create($page = NULL)
        {
                ...
                if ($this->form_validation->run())
                {
                        ...
                        $ok = $this->medical_records_m->create($form_data);
                ...
                else
                {
                        ...
                        $this->template->title('Add Medical Records ')->build('admin/create', $data);
                }
        }
        ...
        function edit($id = FALSE, $page = 0)
        {
                ...
                if (!$this->medical_records_m->exists($id))
                {
                        $this->session->set_flashdata('message', array('type' => 'warning', 'text' => lang('web_object_not_exist')));
                        redirect('admin/medical_records');
                }
                //search the item to show in edit form
                $get = $this->medical_records_m->find($id);
                ...
                if ($this->form_validation->run())  //validation has been passed
                {
                        ...
                        $done = $this->medical_records_m->update_attributes($id, $form_data);
                ...
                $data['result'] = $get;
                //load the view and the layout
                $this->template->title('Edit Medical Records ')->build('admin/create', $data);
        }
        ...
        function delete($id = NULL, $page = 1)
        {
                ...
                //delete the item
                if ($this->medical_records_m->delete($id) == TRUE)
                {
                         //$details = implode(' , ', $this->input->post());
								$user = $this->ion_auth->get_user();
									$log = array(
        ...
        {
                $config = array();
                $config['base_url'] = site_url() . 'admin/medical_records/index/';
                $config['use_page_numbers'] = TRUE;
                $config['per_page'] = 10000000000;
                $config['total_rows'] = $this->medical_records_m->count();
