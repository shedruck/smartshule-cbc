   ...
   function get_subject_result_igcse($exam, $student, $subject)
    {
        ...
        if ($srow)
        {
            ...
            if (count($subs))
            {
                ...
                $sheet = array('subject' => $sbk->name, 'sub_id' => $subject, 'marks' => $rw->marks,'effort' => $rw->effort,'created_by' => $rw->created_by, 'opt' => $ttp, 'units' => $fnsubs, 'inc' => $rw->inc);
            }
            else
            {
                $sheet = array('subject' => $sbk->name, 'sub_id' => $subject, 'marks' => $rw->marks,'effort' => $rw->effort,'created_by' => $rw->created_by, 'opt' => $ttp, 'inc' => $rw->inc);
            }
    ...
    function get_subject_result($exam, $student, $subject)
    {
        ...
        if ($srow)
        {
            ...
            if (count($subs))
            {
                ...
                $sheet = array('subject' => $sbk->name, 'sub_id' => $subject, 'marks' => $rw->marks, 'opt' => $ttp, 'units' => $fnsubs, 'inc' => $rw->inc);
            }
            else
            {
                $sheet = array('subject' => $sbk->name, 'sub_id' => $subject, 'marks' => $rw->marks, 'opt' => $ttp, 'inc' => $rw->inc);
            }
