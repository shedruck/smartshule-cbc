<div class="row actions hidden-print">
    <div class="pull-right clearfix">
        ...
        <a href="<?php echo base_url('admin/exams/bulk_group/' . $exam->id) ?>" class="btn btn-success hidden"><i class="icos-printer"></i> Combined Streams Report
        </a>
    </div>
    <br/>
    <h3>Generate Report Forms</h3>
    <?php
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 col-md-offset-1">
            ...
            <a href="" onClick="window.print(); return false" class="btn btn-primary"><i class="icos-printer"></i> Print
            </a>
        </div>
    </div>
    <?php echo form_close(); ?>
                            ...
                            <table class="topdets">
                                <tr>
                                    ...
                                    <td><strong>ADM No : </strong>
                                        ...
                                        <span class="hidden">&nbsp;&nbsp;&nbsp; <strong>KCPE POS:  </strong><?php //echo $rw->pos; ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>Class : </strong>
                                        <abbr><?php
                                            $crr = isset($this->classes[$rw->student->cl->class]) ? $this->classes[$rw->student->cl->class] : '';
                                            $ctr = isset($streams[$rw->student->cl->stream]) ? $streams[$rw->student->cl->stream] : '';
                                            echo $crr . ' ' . $ctr;
                                            ?>
                                        </abbr>
                                    </td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($rw->marks as $spms)
                                {
                                        ...
                                        $dr = 0;
                                        if ($rank > 1 && in_array($sp->subject, $rw->dropped))
                                        {
                                                $dr = 1;
                                        }
                                        if ($sp->opt == 1)
                                        ...
                                        if (isset($sp->units) && !empty($sp->units))
                                        {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center <?php echo $dr ? 'dropped' : ''; ?>"><?php echo $sp->marks; ?></td>
                                ...
                                <tr class="rttbx">
                                    <td class="text-center"> </td>
                                    <td> TOTAL</td>
                                    <td class="text-center"><?php echo $rank > 1 ? $rw->total_ranked : $gd; ?></td>  
                                    <td>MEAN: &nbsp;&nbsp;&nbsp;<?php
                                ...
                                foreach ($rw->marks as $spms)
                                {
                                        ...
                                        if ($sp->opt != 1)
                                        {
                                                continue; //Optional Subjects Only
                                        }
                                        $i_o++;
                                        if (isset($subjects[$sp->subject]))
                                        {
                                        ...
                                        if (isset($sp->units) && !empty($sp->units))
                                        {
                                                ...
                                                <?php } ?>
                                                <tr>
                                                    <td class="text-center"><?php //echo $i_o;            ?></td>
                                                    <td class="strong"><?php echo $bs->full; ?> TOTAL</td>
                            ...
                            <tr>
                                <td class="nob" width="60%">
                                    <div>						 
                                        ...
                                        <strong><span style="text-decoration:underline">  Principal/Deputy Principal Remarks:</span></strong>
                                        <br>
                                        <hr style="border-top: 2px dotted black"/>
                                    </div>
                                </td>
