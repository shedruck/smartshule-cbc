             ...
             foreach ($payload as $row):
                  ...
                  <div class="slip ">
                      <div class="row center"> 
                          <table class="lethead" border="0" style="border:none !important">
                               <?php
                      ...
                      <table class="ptable" width="100%"  >
                          ...
                          <tbody  id="sort_1">
                             ...
                             foreach ($mks as $ps)
                             {
                                  ...
                                  ?>
                                                         {
                                                         name: "<?php echo $subject_title[$p->subject]; ?>",
                                                         y: <?php echo $p->marks; ?>,
                                                         drilldown: "Exams Performance"
                                                         },
                             <?php } ?>
                                                    ]
                                                    }],
                  ...
                  <?php $xx = $this->portal_m->student_exams($student_id); ?>	

                  <script type="text/javascript">

                       $(function ()
                       { /*
                        $('#line_<?php echo $j; ?>').highcharts({
                        chart: {
                        type: 'column'
                        },
                        title: {
                        text: 'Student Performance Termly'
                        },
                        subtitle: {
                        text: 'Performance'
                        },
                        ...
                        tooltip: {
                        pointFormat: 'Performance: <b>{point.y:.1f} Termly</b>'
                        },
                        series: [{
                        name: 'Population',
                        data: [
              ...
              {
                   ?>
                             ['<?php echo $exams_name[$exams_type_id[$x->exams_id]]; ?>', <?php echo $x->total; ?>],
              <?php } ?>
                        ],
                        dataLabels: {
                        enabled: true,
        ...
        {//single
             if (isset($report) && !empty($report))
             {
                  ...
                  <div class="slip ">
                      ...
                      <table class="lower nonborder" width="100%" border="0"  >
                          <tr><td class="nob" width="60%">
                                  <div>						 
                                      <div class="foo"> </div>
                                      <div class="foo">
