<section class="box ">
        ...
        <header class="panel_header">
                                <h2 class="title pull-left"><?php echo   ($updType == 'edit') ? 'Edit ' : 'Add ';?>Subordinate </h2>
                               <div class="actions panel_actions pull-right">
                                    <?php echo anchor( 'admin/subordinate/create' , '<span><i class="fa fa-plus white"></i> Add Subordinate</span>', 'class="btn btn-success" ');?> 
                        <?php echo anchor( 'admin/subordinate' , '<span><i class="fa fa-list white"></i> All Subordinate' .'</span>', 'class="btn btn-info"');?> 
                                </div>
                            </header>
