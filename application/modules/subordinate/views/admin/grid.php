   ...
   <div class="col-md-3">               
                <div class="userCard">
                    ...
                    <div class="">
						...
						<p style="text-align:center">
							<a href="<?php echo site_url('admin/subordinate/profile/'.$p->id);?>" class="btn btn-success">Profile</a>
							<a href="<?php echo site_url('admin/subordinate/edit/'.$p->id);?>" class="btn btn-primary">Edit</a>
							<?php if($p->status==1){?>
							<a onClick="return confirm('Are you sure you want to make this member inactive')" href="<?php echo site_url('admin/subordinate/disable/'.$p->id.'/'.$page);?>"class="btn btn-danger">Disable</a>
							<?php }else{ ?>
							   	<a onClick="return confirm('Are you sure you want to make this member active')" href="<?php echo site_url('admin/subordinate/enable/'.$p->id.'/'.$page);?>"class="btn btn-warning">Enable</a>
							<?php } ?>
                        </p>
                    </div>
                </div>
