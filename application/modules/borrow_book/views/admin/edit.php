...
<div class='form-group'>
	<div class="col-md-2" for='student'>Student </div><div class="col-md-10">
	   <?php
                ...
                echo form_dropdown('student', array('' => 'Select Student') + $data, (isset($result->student)) ? $result->student : '', ' class="chzn-select" data-placeholder="Select Options..." ');
                ?>
...
<div class='form-group'><div class="col-md-2"></div><div class="col-md-10">
	...
	<?php echo anchor('admin/borrow_book','Cancel','class="btn  btn-default"');?>
</div></div>
