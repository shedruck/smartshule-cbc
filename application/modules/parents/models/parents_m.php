...
// Call the Model constructor
        ...
        {
                $this->select_all_key('parents');
                return $this->db->order_by('id', 'desc')->get('parents')->result();
        }
    ...
    function assign_parent($data)
    {
        ...
        {
            $arr[] =  [
                'names' => strtolower($res->first_name.'.'.$res->last_name),
                'user_id' => $res->user_id,
                'id' => $res->id,
                'email' =>strtolower($res->first_name.$res->id.'.'.$res->last_name).'@ack-htc.com', 
            ];
        }
