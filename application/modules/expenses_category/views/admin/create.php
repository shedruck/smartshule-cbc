...
<div class='form-group'>
	<label class='col-md-2' for='account'>Account </label><div class="col-md-6">
	<?php
     echo form_dropdown('account', array('' => 'Select   Account') + $accounts, '  class="select Select-2 validate[required]" id="account_"');
...
<div class="col-md-6">
	...
	<?php echo anchor('admin/expenses_category','Cancel','class="btn btn-danger"');?>
</div>
</div>
