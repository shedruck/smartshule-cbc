<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  Books Category  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/books_category/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Books Category')), 'class="btn btn-primary"');?> 
...
<div class='form-group'><div class="col-md-2"></div><div class="col-md-10">
	...
	<?php echo anchor('admin/books_category','Cancel','class="btn  btn-default"');?>
</div></div>
