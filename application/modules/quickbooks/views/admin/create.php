<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  Quickbooks  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/quickbooks/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'Quickbooks')), 'class="btn btn-primary"');?> 
...
<div class='form-group'>
	<div class="col-md-2" for='day'>Day </div><div class="col-md-10">
...
<div class='form-group'><div class="col-md-2"></div><div class="col-md-10">
	...
	<?php echo anchor('admin/quickbooks','Cancel','class="btn  btn-default"');?>
</div></div>
