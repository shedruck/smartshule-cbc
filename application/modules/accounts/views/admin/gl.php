            ...
            <div class="widget">
                    ...
                    <h3> 
                        ...
                        $to = "";
                            if($this->input->post()){
                                ...
                                if(($from) && ($to)){
                                    $head = "GENERAL LEDGER REPORT BETWEEN $from AND $to";
                                }else if($from){
                                    $head = "GENERAL LEDGER REPORT AS AT $from";
                                }else if($to){
                                    $head = "GENERAL LEDGER REPORT AS AT $to";
                                }
                            }else{
                                $head = "GENERAL LEDGER REPORT";
                            }
                            echo $head;
                        ?>
                    </h3>
                ...
                <div id="tabxx">
                    ...
                    <table cellpadding="0" cellspacing="0" width="80%" style="margin: 15px auto;">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5"><h4><b>Accounts Receivable</b></h4></td>
                            </tr>
                            <!-- Accounts Receivable -->
