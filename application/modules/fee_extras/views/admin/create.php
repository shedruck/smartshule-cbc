<div class="col-md-8">
    ...
    <div class="block-fluid">
        ...
        <div class="form-group">
            <div class="col-md-3">Discounted: </div>
            <div class="col-md-8"> 
                <?php
                $disc = '';
                if ($result->discounted == 1)
                {
                ...
                {
                        $ndisc = 'checked="checked"';
                }
                ?>
                <div class = "radio"> <input type = "radio"  <?php echo $disc; ?> name = "discounted" class = "validate" value = "1"> </div>Yes
                <div class = "radio"> <input type = "radio" <?php echo $ndisc; ?> name = "discounted" value = "0" class = "validate"> </div>No
            </div>
        </div>
