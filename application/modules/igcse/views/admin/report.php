        ...
        <div class="row-fluid center">
            <div class="col-sm-12">
                ...
                <h4>
                    ...
                    if ($thread) {
                        echo $c_t . ' - ' . $thread->title . ' - Term ' . $thread->term . ' ' . $thread->year;
                    }
                    ?>
                </h4>
                <br>
        ...
        <table class="table" width="100">
            <thead>
                <tr>
                    ...
                    <td>Name</td>
                    <?php
                    foreach ($subjects as $subid => $details) {
                        ${'sub_' . $subid} = 0;
                    ?>
                        <th><?php echo strtoupper($details['short_name']) ?></th>
                    <?php } ?>
                    <td>Total</td>
                    <th>Mean Mark</th>
                    <th>Mean Grade</th>
            ...
            <tbody>
                        ...
                        ?>
                            <td>
                                ...
                                foreach ($subscores as $score) {
                                    if ($subid == $score->subject) {
                                        echo $score->total;
                                        ${'sub_' . $subid} += $score->total;
                                    }
                                }
                                ?>
                            </td>
                ...
                <tr>
                    <td></td>
                    <td class="text-right"><b>Mean Score</b></td>
                    <?php
                    foreach ($subjects as $subid => $details) {
                    ?>
                        <td><b><?php echo round(${'sub_' . $subid} / count($results)) ?></b></td>
                    <?php } ?>
                    <td>
                        <b>
                            <?php
                            echo round($totals / count($results));
                            ?>
                        </b>
                    </td>
                    <td>
                        <b>
                            <?php
                            $mean = round($means / count($results));
                            echo round($means / count($results));
                            ?>
                        </b>
                    </td>
                    <td>
                        ...
                        <?php 
                            ...
                            //Find grade
                            $grading = $this->igcse_m->retrieve_grading($gid[0]);
                            foreach ($grading as $gy => $grad) {
                                if ($mean >= $grad->minimum_marks && $mean <= $grad->maximum_marks) {
                                    $grade = $grad->grade;
                                }
                            }
