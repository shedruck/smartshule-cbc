        ...
        <div class="panel-body" style="display: block;">    
            ...
            <div class='col-sm-6'>	
                ...
                <div class='form-group'>
				 ...
				 <div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>PIN Number <span class='required'>*</span></label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
						...
						<div class='form-group '>
							<label class=' col-sm-3 control-label' for='disability'>Disabled <span class='required'>*</span></label><div class="col-md-9">
						...
						<div class='form-group '>
			<label class=' col-sm-3 control-label' for='disability_type'>Disability Type </label><div class="col-md-9">
            ...
            <div class='col-sm-6'>			
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>TSC Employee  <span class='required'>*</span></label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>TSC Number </label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>KNUT Member  <span class='required'>*</span></label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>KNUT Number </label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>KUPPET Member  <span class='required'>*</span></label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
				...
				<div class='form-group'>
                    <label class=' col-sm-3 control-label' for='email'>KUPPET Number </label><div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-list"></i>
                            </span>
			 ...
			 <div class='col-sm-12'>	
			     ...
			     <div class='form-group'>
                    <label class=' col-sm-3 control-label' for='subjects'>  Subjects Specialized in </label><div class="col-sm-8">
		   ...
		   <div class="col-sm-12">
            <div class="col-sm-6">	
                ...
                <div class='form-group'>
                    <label class=' col-sm-3 control-label' for='additionals'>Additional Info </label><div class="col-sm-9">
