 ...
 <!-- BEGIN TABLE DATA -->
     ...
     echo form_error('employee'); ?>
													...
													<input type="text" name="amount[]" id="amount" class="amount" value="<?php 
													  ...
													  <td width="37%">
														<textarea name="comment[]" cols="25" rows="1" class="col-md-12 comment  validate[required]" style="resize:vertical;" id="comment"><?php echo set_value('comment', (isset($result->comment)) ? htmlspecialchars_decode($result->comment) : ''); ?></textarea>
													</td>
...
$(function () {
    ...
    // manipulate the name/id values of the input inside the new element
        ...
        // subject - select
         ...
         newElem.find('.advance_date').attr('id', 'ID' + newNum + '_advance_date').val('').removeClass("hasDatepicker").datepicker({
                format: "dd MM yyyy",
            }).focus();;
