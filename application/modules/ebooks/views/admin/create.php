<div class="col-md-8">
        <div class="head"> 
            ...
            <h2>  E-books  </h2>
             <div class="right"> 
             <?php echo anchor( 'admin/ebooks/create' , '<i class="glyphicon glyphicon-plus">
                </i> '.lang('web_add_t', array(':name' => 'E-books')), 'class="btn btn-primary"');?> 
              <?php echo anchor( 'admin/ebooks' , '<i class="glyphicon glyphicon-list">
                </i> '.lang('web_list_all', array(':name' => 'E-books')), 'class="btn btn-primary"');?> 
...
<div class='form-group'>
	<div class="col-md-3" for='author'>Author </div><div class="col-md-6">
...
<div class='form-group'>
	<div class="col-md-3" for='file'>Upload Book (pdf) </div>
 <div class="col-md-6">
	<input id='file' type='file' name='file' />

	<?php if ($updType == 'edit'): ?>
	<a href='/public/uploads/ebooks/files/<?php echo $result->file?>' />Download actual file (file)</a>
	<?php endif ?>
...
<div class='form-group'><div class="col-md-3"></div><div class="col-md-6">
	...
	<?php echo anchor('admin/ebooks','Cancel','class="btn  btn-default"');?>
</div></div>
