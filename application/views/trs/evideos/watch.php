										 ...
										 $i++;
                                            ...
                                            <div class="media latest-post-item">
                                                <div class="media-left">
                                                    <a href="<?php echo base_url('trs/watch/'.$p->subject.'/'.$class.'/'.$this->session->userdata['session_id'].'/'.$p->id)?>"> <img class="media-object" alt="64x64" src="<?php echo $p->preview_link;?>" style="width: 100px; height: 66px;"> </a>
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="media-heading">
													<a href="<?php echo base_url('trs/watch/'.$p->subject.'/'.$class.'/'.$this->session->userdata['session_id'].'/'.$p->id)?>"><?php echo strtoupper($p->title);?></a> </h5>
