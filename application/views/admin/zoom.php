        ...
        <div class="container">
            ...
            <div id="navbar" class="websdktest">
                <form class="navbar-form navbar-right" id="meeting_form">
                    <input type="hidden" id="username" value="<?php echo $this->user->first_name?> <?php echo $this->user->last_name?>">
...
<script>
    ...
    <script src="<?php echo base_url('assets/default/zoom/js/tool.js')?>"></script>
    <script src="<?php echo base_url('assets/default/zoom/js/vconsole.min.js')?>"></script>
    <script src="<?php echo base_url('assets/default/zoom/js/index.js')?>"></script>
