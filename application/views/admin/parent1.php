<?php
$firstname= $this->ion_auth->get_user()->first_name;
...
if($pwd == ""){
    ...
    $(document).ready(function(){
       ...
       swal({
            title: 'Important',
            text: `Dear $firstname, Please change your password  to keep your account secure🤝`,
            type: 'success',
...
<a href="<?php echo base_url()?>portals/parents/malipo"><img src="https://sharasolutions.com/wp-content/uploads/2019/02/lipa-na-mpesa.png" width="10%"></a>
