...
<div class="col-md-3"></div>
    ...
    <div class="login col-md-6 col-sm-12" id="forgot">
        ...
        <div class="wrap">
                <h3 style="text-align:center">Please Enter Reset Code</h3>
                <?php echo form_open("index/forgotPasswordCode", ' class="form-login" ');
                    ?> 
                <div class="row-fluid">
                    <p style="text-align:center">Please Enter the code sent to your phone number</p>
                    <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            <input type="text" class="form-control" name="code" required="required" placeholder="Forgot password code *"/>
                    </div>  
                    <br>
                    <div class="col-md-8"></div>
                    <div class="col-md-4 pull-right" >
                        <button class="btn btn-block btn-primary" type="submit" name="code_submit">Submit</button>
                    </div>
                    <br>
