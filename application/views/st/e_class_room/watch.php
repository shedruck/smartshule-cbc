<div class="portlet mt-2">
    <div class="portlet-heading portlet-default border-bottom">
		...
		<?php $classes = $this->portal_m->get_class_options(); ?>
             <?php echo $classes[$class] ?> - <?php echo $subject ?>  E-Videos
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="blog-post m-b-30">
                                            <div class="post-image">
                                                ...
                                                <span class="label label-danger"><?php echo $subject ?> </span>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <blockquote class="custom-blockquote margin-t-30">
                                                    ...
                                                    <footer>
                                                        Level <cite title="Source Title"><?php if($post->level=='999') echo 'General'; else  echo $classes[$post->level];?></cite>
                                                    </footer>
													<footer>
                                                        Subject <cite title="Source Title"><?php echo $sub[$post->subject];?></cite>
                                                    </footer>
													<footer>
										 ...
										 $i++;
                                            ...
                                            <div class="media latest-post-item">
                                                <div class="media-left">
                                                    <a href="<?php echo base_url('st/watch/'.$p->subject.'/'.$this->session->userdata['session_id'].'/'.$p->id)?>"> <img class="media-object" alt="64x64" src="<?php echo $p->preview_link;?>" style="width: 100px; height: 66px;"> </a>
                                                </div>
                                                <div class="media-body">
                                                    <h5 class="media-heading"><a href="<?php echo base_url('st/watch/'.$p->subject.'/'.$this->session->userdata['session_id'].'/'.$p->id)?>"><?php echo strtoupper($p->title);?></a> </h5>
