    ...
    <div class="col-md-12">
        <div class="card recent-operations-card">
            <div class="card-block1">  
                <div class="page-header buttons-hide print">
                    <div class="page-block">
                        <div class="row align-items-center">
                          ...
                          return false" class="btn btn-success" type="button"><span class="fa fa-print"></span> Print Receipt </button>
						 	<?php echo anchor( 'st#finance' , '<i class="fa fa-caret-left">
        ...
        <div class="slip-content">
            ...
            <div class="row">
                <div class="col-sm-3 invoice-left">
                    <img  src="<?php echo base_url('uploads/files/' . $settings->document); ?>" class="center" align="" style="" width="100" height="100" />
                </div>
                ...
                <div class="col-md-3 text-right">
                    <h5>RECEIPT NO.<span style=" color:red;"> <?php echo $total->id; ?></span></h5>
                    <strong>ADM NO. </strong> <?php
                    ...
                    ?>
                    <br> 
                    DATE: <span><?php echo date('d M, Y', time()); ?></span>
					<br> 
                    TIME: <span><?php echo date('H:i', time()); ?></span>
                </div>
            </div>
         </div>
		 
          <div class="col-sm-12" style="margin-bottom:5px;margin-top:5px;border-top: #eee solid 1px">
                <div class="col-sm-12">
                    <strong>Received From:</strong> <span><?php echo $st->first_name . ' ' . $st->last_name; ?> </span>
                    <span>- <b>Class:</b> <?php echo $class; ?></span>
                </div>
                <div class="col-sm-12">
            ...
            <div class="">
                <div class="text-center" style="border-top:1px solid #ccc">		
                    <span class="text-center" style="font-size:0.8em !important;text-align:center !important;">
                         <?php
                             if (!empty($settings->tel))
                             {
